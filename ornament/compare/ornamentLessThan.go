// ornament/compare/ornamentLessThan.go
//
...
type OrnamentLessThan struct {
	device.OrnamentOpAmpSymbol
}

func (e *OrnamentLessThan) Init() (err error) {
...
func (e *OrnamentLessThan) Update(x, y, width, height rulesDensity.Density) (err error) {
