...
func (e *StatementConstInt) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementConstInt) SetComment(c string) { e.comment = c }
...
func (e *StatementConstInt) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementConstInt) OpenInspect() { go e.showInspectOverlay() }
