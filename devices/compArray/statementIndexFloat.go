// devices/compArray/statementIndexFloat.go
// SPDX-FileCopyrightText: 2026 Helmut Kemper
// SPDX-License-Identifier: AGPL-3.0-only

package compArray

// statementIndexFloat.go — Array index reader device, INT element type.
//
...
// kIndexFloatElement is the FIXED element type of this device. GetProperties
// exports it as "elementType"; the array port advertises "[]"+kIndexFloatElement,
// and the value port advertises kIndexFloatElement.
const kIndexFloatElement = "float"

// kIndexBody (the shared "index" body label) is declared once in
// statementIndexInt.go, so all three index readers share it.

// StatementIndexFloat is the int-element array index reader device.
type StatementIndexFloat struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementIndexFloat) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementIndexFloat) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementIndexFloat) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementIndexFloat) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementIndexFloat) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

func (e *StatementIndexFloat) SetContextMenu(c *contextMenu.Controller) { e.ctxMenu = c }
func (e *StatementIndexFloat) SetOnRemove(fn func(id string))           { e.onRemove = fn }

// Port type tokens. The array port carries the slice type ("[]int"); value is
// the element ("int"); index is always "int"; ok is "bool".
func (e *StatementIndexFloat) arrayType() string { return "[]" + kIndexFloatElement }
func (e *StatementIndexFloat) valueType() string { return kIndexFloatElement }
func (e *StatementIndexFloat) indexType() string { return "int" }
func (e *StatementIndexFloat) okType() string    { return "bool" }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementIndexFloat) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementIndexFloat) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
// ver na tela.
func (e *StatementIndexFloat) connectorLayout() (leftX, rightX, upperY, lowerY float64) {
	w := e.width.GetFloat()
...
func (e *StatementIndexFloat) renderSVG() string {
	w := e.width.GetFloat()
	h := e.height.GetFloat()
...
func (e *StatementIndexFloat) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementIndexFloat) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("indexFloat")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[IndexFloat] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementIndexFloat) connectorAt(lx, ly float64) string {
	leftX, rightX, upperY, lowerY := e.connectorLayout()
...
func (e *StatementIndexFloat) wireEvents() {
...
// canonical order.
func (e *StatementIndexFloat) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[IndexFloat] delete: %s", e.id); e.Remove() }),
...
func (e *StatementIndexFloat) showInspectOverlay() { overlay.Show(e.inspectConfig()) }
...
func (e *StatementIndexFloat) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: indexFloatHelp()},
		},
...
func (e *StatementIndexFloat) GetInspectConfig() interface{} { return e.inspectConfig() }
...
func (e *StatementIndexFloat) ApplyProperties(values map[string]string) {
...
func (e *StatementIndexFloat) RegisterConnectors() {
...
func (e *StatementIndexFloat) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementIndexFloat) Get() *html.TagSvg { return nil }
func (e *StatementIndexFloat) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementIndexFloat) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementIndexFloat) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementIndexFloat) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementIndexFloat) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementIndexFloat) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementIndexFloat) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementIndexFloat) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementIndexFloat) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementIndexFloat) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementIndexFloat) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementIndexFloat) GetInitialized() bool   { return e.initialized }
func (e *StatementIndexFloat) GetID() string          { return e.id }
func (e *StatementIndexFloat) GetName() string        { return e.name }
func (e *StatementIndexFloat) GetSelected() bool      { return e.selected }
func (e *StatementIndexFloat) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementIndexFloat) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementIndexFloat) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementIndexFloat) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementIndexFloat) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementIndexFloat) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementIndexFloat) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementIndexFloat) GetStatus() int  { return e.iconStatus }
func (e *StatementIndexFloat) SetStatus(s int) { e.iconStatus = s }
func (e *StatementIndexFloat) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementIndexFloat) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementIndexFloat) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementIndexFloat) SetResizeEnable(_ bool) {
	if e.elem != nil {
		e.elem.SetResizeEnable(false)
		e.elem.ShowResizeButtons(false)
	}
...
func (e *StatementIndexFloat) GetIconName() string     { return "IndexFloat" }
func (e *StatementIndexFloat) GetIconCategory() string { return "Array" }

func (e *StatementIndexFloat) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementIndexFloat) GetDeviceType() string { return "StatementIndexFloat" }
func (e *StatementIndexFloat) GetProperties() map[string]interface{} {
	...
	props := map[string]interface{}{
		"elementType": kIndexFloatElement,
		"label":       e.label,
	}
	if e.comment != "" {
...
func (e *StatementIndexFloat) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementIndexFloat) SetComment(c string) { e.comment = c }
func (e *StatementIndexFloat) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementIndexFloat) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementIndexFloat) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementIndexFloat) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help ──────────────────────────────────────────────────────────────────────

func indexFloatHelp() string {
	return `# Index (float) — Read an item from a collection

Reads the item at a given **position** from a floating-point collection and outputs
...
|-------|---------|----------|----------------------------------|
| array | ` + "`[]float`" + ` | yes      | the collection to read from      |
...
| Port  | Type   | Meaning                                             |
|-------|--------|-----------------------------------------------------|
| value | ` + "`float`" + `  | the item at that position — **0** if out of range   |
...
- Sibling devices exist for **int** and **string** collections.
`
}
...
func (e *StatementIndexFloat) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementIndexFloat) OpenInspect() { go e.showInspectOverlay() }
