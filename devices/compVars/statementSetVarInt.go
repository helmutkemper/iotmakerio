// /ide/devices/compVars/statementSetVarInt.go
// SPDX-FileCopyrightText: 2026 Helmut Kemper
// SPDX-License-Identifier: AGPL-3.0-only

package compVars

// statementSetVarInt.go — Set-variable device (int).
//
...
//	│ SET             int │  ← 18px header: "SET" tag (left), type label (right)
//	├─────────────────────┤  ← divider
//	│                     │
//	│   ◉   counter       │  ← variable name, 16px bold, centered; ◉ = input connector
//	│                     │
//	└─────────────────────┘
//	setVarInt1              ← editable label, 12px muted
//
...
// numa variável de projeto do tipo int. No codegen, um SetVar emite uma
...
// StatementSetVarInt is a set-variable device for type int.
// Single input connector "value" — assigns the wired value to the variable.
type StatementSetVarInt struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementSetVarInt) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementSetVarInt) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementSetVarInt) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementSetVarInt) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementSetVarInt) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementSetVarInt) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementSetVarInt) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementSetVarInt) GetVarName() string             { return e.varName }
func (e *StatementSetVarInt) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementSetVarInt) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementSetVarInt) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementSetVarInt) renderSVG() string {
	w := e.width.GetFloat()
...
func (e *StatementSetVarInt) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementSetVarInt) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("setVarInt")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[SetVarInt] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementSetVarInt) wireEvents() {
...
func (e *StatementSetVarInt) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[SetVarInt] delete: %s", e.id); e.Remove() }),
...
func (e *StatementSetVarInt) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementSetVarInt) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: setVarIntHelp()},
		},
...
func (e *StatementSetVarInt) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementSetVarInt) ApplyProperties(values map[string]string) {
	if v, ok := values["comment"]; ok {
		e.comment = v
	}
	if v, ok := values["varName"]; ok {
...
func (e *StatementSetVarInt) RegisterConnectors() {
...
func (e *StatementSetVarInt) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementSetVarInt) Get() *html.TagSvg { return nil }
func (e *StatementSetVarInt) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementSetVarInt) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarInt) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementSetVarInt) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementSetVarInt) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementSetVarInt) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementSetVarInt) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementSetVarInt) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementSetVarInt) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarInt) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarInt) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementSetVarInt) GetInitialized() bool   { return e.initialized }
func (e *StatementSetVarInt) GetID() string          { return e.id }
func (e *StatementSetVarInt) GetName() string        { return e.name }
func (e *StatementSetVarInt) GetSelected() bool      { return e.selected }
func (e *StatementSetVarInt) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementSetVarInt) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementSetVarInt) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementSetVarInt) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementSetVarInt) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementSetVarInt) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementSetVarInt) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementSetVarInt) GetStatus() int  { return e.iconStatus }
func (e *StatementSetVarInt) SetStatus(s int) { e.iconStatus = s }
func (e *StatementSetVarInt) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementSetVarInt) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementSetVarInt) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementSetVarInt) SetResizeEnable(_ bool) {
...
func (e *StatementSetVarInt) GetIconName() string     { return "SetVarInt" }
func (e *StatementSetVarInt) GetIconCategory() string { return "Variables" }

func (e *StatementSetVarInt) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementSetVarInt) GetDeviceType() string { return "StatementSetVarInt" }
func (e *StatementSetVarInt) GetProperties() map[string]interface{} {
...
func (e *StatementSetVarInt) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementSetVarInt) SetComment(c string) { e.comment = c }
...
// contribui.
func (e *StatementSetVarInt) GetVariableDecl() (name string, typ string) {
	return e.varName, "int"
}
func (e *StatementSetVarInt) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementSetVarInt) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementSetVarInt) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementSetVarInt) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func setVarIntHelp() string {
	return `# SetVarInt — Set Integer Variable
...
|----------|--------|------------------------------------|
| Variable | string | Name of the int variable to write  |
...
func (e *StatementSetVarInt) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementSetVarInt) OpenInspect() { go e.showInspectOverlay() }
