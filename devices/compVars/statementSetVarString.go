...
func (e *StatementSetVarString) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementSetVarString) SetComment(c string) { e.comment = c }
...
func (e *StatementSetVarString) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementSetVarString) OpenInspect() { go e.showInspectOverlay() }
