// /ide/devices/compVars/statementGetVarFloat.go
// SPDX-FileCopyrightText: 2026 Helmut Kemper
// SPDX-License-Identifier: AGPL-3.0-only

package compVars

// statementGetVarFloat.go — Get-variable device (int).
//
...
//	│ VAR           float │  ← 18px header: "VAR" tag (left), type label (right)
//	├─────────────────────┤  ← divider
//	│                     │
//	│       counter   ◉   │  ← variable name, 16px bold, centered; ◉ = output connector
//	│                     │
//	└─────────────────────┘
//	getVarFloat1              ← editable label, 12px muted
//
...
// StatementGetVarFloat is a get-variable device for type int.
// No inputs — single output connector that emits the variable's float value.
type StatementGetVarFloat struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementGetVarFloat) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementGetVarFloat) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementGetVarFloat) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementGetVarFloat) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementGetVarFloat) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementGetVarFloat) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementGetVarFloat) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementGetVarFloat) GetVarName() string             { return e.varName }
func (e *StatementGetVarFloat) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementGetVarFloat) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementGetVarFloat) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementGetVarFloat) renderSVG() string {
	w := e.width.GetFloat()
...
func (e *StatementGetVarFloat) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementGetVarFloat) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("getVarFloat")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[GetVarFloat] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementGetVarFloat) wireEvents() {
...
func (e *StatementGetVarFloat) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[GetVarFloat] delete: %s", e.id); e.Remove() }),
...
func (e *StatementGetVarFloat) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementGetVarFloat) inspectConfig() overlay.Config {
...
func (e *StatementGetVarFloat) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementGetVarFloat) ApplyProperties(values map[string]string) {
	if v, ok := values["comment"]; ok {
		e.comment = v
	}
	if v, ok := values["varName"]; ok {
...
func (e *StatementGetVarFloat) RegisterConnectors() {
...
func (e *StatementGetVarFloat) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementGetVarFloat) Get() *html.TagSvg { return nil }
func (e *StatementGetVarFloat) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementGetVarFloat) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementGetVarFloat) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementGetVarFloat) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementGetVarFloat) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementGetVarFloat) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementGetVarFloat) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementGetVarFloat) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementGetVarFloat) GetInitialized() bool   { return e.initialized }
func (e *StatementGetVarFloat) GetID() string          { return e.id }
func (e *StatementGetVarFloat) GetName() string        { return e.name }
func (e *StatementGetVarFloat) GetSelected() bool      { return e.selected }
func (e *StatementGetVarFloat) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementGetVarFloat) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementGetVarFloat) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementGetVarFloat) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementGetVarFloat) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementGetVarFloat) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementGetVarFloat) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementGetVarFloat) GetStatus() int  { return e.iconStatus }
func (e *StatementGetVarFloat) SetStatus(s int) { e.iconStatus = s }
func (e *StatementGetVarFloat) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementGetVarFloat) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementGetVarFloat) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementGetVarFloat) SetResizeEnable(_ bool) {
...
func (e *StatementGetVarFloat) GetIconName() string     { return "GetVarFloat" }
func (e *StatementGetVarFloat) GetIconCategory() string { return "Variables" }

func (e *StatementGetVarFloat) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementGetVarFloat) GetDeviceType() string { return "StatementGetVarFloat" }
func (e *StatementGetVarFloat) GetProperties() map[string]interface{} {
...
func (e *StatementGetVarFloat) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementGetVarFloat) SetComment(c string) { e.comment = c }
...
// contribui.
func (e *StatementGetVarFloat) GetVariableDecl() (name string, typ string) {
	return e.varName, "float"
}
func (e *StatementGetVarFloat) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarFloat) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarFloat) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementGetVarFloat) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func getVarFloatHelp() string {
	return `# GetVarFloat — Get Integer Variable
...
func (e *StatementGetVarFloat) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementGetVarFloat) OpenInspect() { go e.showInspectOverlay() }
