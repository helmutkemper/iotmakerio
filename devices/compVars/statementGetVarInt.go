// /ide/devices/compVars/statementGetVarInt.go
// SPDX-FileCopyrightText: 2026 Helmut Kemper
// SPDX-License-Identifier: AGPL-3.0-only

package compVars

// statementGetVarInt.go — Get-variable device (int).
//
...
//
//	┌─────────────────────┐  ← 2px border, 5px corner radius, type color (int = blue)
//	│ VAR             int │  ← 18px header: "VAR" tag (left), type label (right)
//	├─────────────────────┤  ← divider
//	│                     │
//	│       counter   ◉   │  ← variable name, 16px bold, centered; ◉ = output connector
//	│                     │
//	└─────────────────────┘
//	getVarInt1              ← editable label, 12px muted
//
...
// StatementGetVarInt is a get-variable device for type int.
// No inputs — single output connector that emits the variable's int value.
type StatementGetVarInt struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementGetVarInt) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementGetVarInt) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementGetVarInt) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementGetVarInt) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementGetVarInt) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementGetVarInt) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementGetVarInt) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementGetVarInt) GetVarName() string             { return e.varName }
func (e *StatementGetVarInt) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementGetVarInt) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementGetVarInt) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementGetVarInt) renderSVG() string {
	w := e.width.GetFloat()
...
func (e *StatementGetVarInt) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementGetVarInt) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("getVarInt")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[GetVarInt] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementGetVarInt) wireEvents() {
...
func (e *StatementGetVarInt) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[GetVarInt] delete: %s", e.id); e.Remove() }),
...
func (e *StatementGetVarInt) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementGetVarInt) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: getVarIntHelp()},
		},
...
func (e *StatementGetVarInt) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementGetVarInt) ApplyProperties(values map[string]string) {
	if v, ok := values["comment"]; ok {
		e.comment = v
	}
	if v, ok := values["varName"]; ok {
...
func (e *StatementGetVarInt) RegisterConnectors() {
...
func (e *StatementGetVarInt) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementGetVarInt) Get() *html.TagSvg { return nil }
func (e *StatementGetVarInt) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementGetVarInt) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarInt) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementGetVarInt) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementGetVarInt) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementGetVarInt) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementGetVarInt) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementGetVarInt) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementGetVarInt) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarInt) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarInt) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementGetVarInt) GetInitialized() bool   { return e.initialized }
func (e *StatementGetVarInt) GetID() string          { return e.id }
func (e *StatementGetVarInt) GetName() string        { return e.name }
func (e *StatementGetVarInt) GetSelected() bool      { return e.selected }
func (e *StatementGetVarInt) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementGetVarInt) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementGetVarInt) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementGetVarInt) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementGetVarInt) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementGetVarInt) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementGetVarInt) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementGetVarInt) GetStatus() int  { return e.iconStatus }
func (e *StatementGetVarInt) SetStatus(s int) { e.iconStatus = s }
func (e *StatementGetVarInt) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementGetVarInt) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementGetVarInt) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementGetVarInt) SetResizeEnable(_ bool) {
...
func (e *StatementGetVarInt) GetIconName() string     { return "GetVarInt" }
func (e *StatementGetVarInt) GetIconCategory() string { return "Variables" }

func (e *StatementGetVarInt) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementGetVarInt) GetDeviceType() string { return "StatementGetVarInt" }
func (e *StatementGetVarInt) GetProperties() map[string]interface{} {
...
func (e *StatementGetVarInt) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementGetVarInt) SetComment(c string) { e.comment = c }
...
// contribui.
func (e *StatementGetVarInt) GetVariableDecl() (name string, typ string) {
	return e.varName, "int"
}
func (e *StatementGetVarInt) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarInt) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarInt) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementGetVarInt) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func getVarIntHelp() string {
	return `# GetVarInt — Get Integer Variable
