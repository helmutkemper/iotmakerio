// /ide/devices/compVars/statementGetVarFloat32.go

package compVars

// statementGetVarFloat32.go — Get-variable device (float32).
//
// Reads a user-declared project variable of type int and emits its current
...
//	│ VAR           float32 │  ← 18px header: "VAR" tag (left), type label (right)
//	├─────────────────────┤  ← divider
//	│                     │
//	│       counter   ◉   │  ← variable name, 16px bold, centered; ◉ = output connector
//	│                     │
//	└─────────────────────┘
//	getVarFloat321              ← editable label, 12px muted
//
// Body click:      Inspect · Delete
// Connector click: Connect (output-only)
// Double-click:    Inspect overlay
//
// Português: Device "ler variável" (int). Lê uma variável de projeto do tipo
// int e emite o valor atual numa saída. No codegen, um GetVar NÃO emite
// instrução — a saída é alias do registrador da variável. Uma saída, sem
// entradas.
...
// StatementGetVarFloat32 is a get-variable device for type float32.
// No inputs — single output connector that emits the variable's float32 value.
type StatementGetVarFloat32 struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementGetVarFloat32) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementGetVarFloat32) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementGetVarFloat32) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementGetVarFloat32) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementGetVarFloat32) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementGetVarFloat32) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementGetVarFloat32) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementGetVarFloat32) GetVarName() string             { return e.varName }
func (e *StatementGetVarFloat32) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementGetVarFloat32) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementGetVarFloat32) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementGetVarFloat32) renderSVG() string {
	w := e.width.GetFloat()
	...
	ts := rulesDevice.TypeStyleFor("float32")
	...
	svg += fmt.Sprintf(
		`<text x="%.1f" y="%.1f" font-family="%s" font-size="%d" fill="%s" text-anchor="end" dominant-baseline="middle">float32</text>`,
...
func (e *StatementGetVarFloat32) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementGetVarFloat32) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("getVarFloat32")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[GetVarFloat32] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementGetVarFloat32) wireEvents() {
...
func (e *StatementGetVarFloat32) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[GetVarFloat32] delete: %s", e.id); e.Remove() }),
...
func (e *StatementGetVarFloat32) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementGetVarFloat32) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: getVarFloat32Help()},
		},
...
func (e *StatementGetVarFloat32) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementGetVarFloat32) ApplyProperties(values map[string]string) {
	if v, ok := values["varName"]; ok {
		e.varName = v
	}
	if lbl, ok := values["label"]; ok {
...
func (e *StatementGetVarFloat32) RegisterConnectors() {
...
func (e *StatementGetVarFloat32) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementGetVarFloat32) Get() *html.TagSvg { return nil }
func (e *StatementGetVarFloat32) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementGetVarFloat32) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat32) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementGetVarFloat32) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementGetVarFloat32) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementGetVarFloat32) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementGetVarFloat32) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementGetVarFloat32) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementGetVarFloat32) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat32) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat32) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementGetVarFloat32) GetInitialized() bool   { return e.initialized }
func (e *StatementGetVarFloat32) GetID() string          { return e.id }
func (e *StatementGetVarFloat32) GetName() string        { return e.name }
func (e *StatementGetVarFloat32) GetSelected() bool      { return e.selected }
func (e *StatementGetVarFloat32) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementGetVarFloat32) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementGetVarFloat32) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementGetVarFloat32) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementGetVarFloat32) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementGetVarFloat32) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementGetVarFloat32) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementGetVarFloat32) GetStatus() int  { return e.iconStatus }
func (e *StatementGetVarFloat32) SetStatus(s int) { e.iconStatus = s }
func (e *StatementGetVarFloat32) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementGetVarFloat32) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementGetVarFloat32) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementGetVarFloat32) SetResizeEnable(_ bool) {
...
func (e *StatementGetVarFloat32) GetIconName() string     { return "GetVarFloat32" }
func (e *StatementGetVarFloat32) GetIconCategory() string { return "Variables" }

func (e *StatementGetVarFloat32) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementGetVarFloat32) GetDeviceType() string { return "StatementGetVarFloat32" }
func (e *StatementGetVarFloat32) GetProperties() map[string]interface{} {
...
//
// Português: Implementa scene.VariableDeclarer — declara a variável inteira que
...
// contribui.
func (e *StatementGetVarFloat32) GetVariableDecl() (name string, typ string) {
	return e.varName, "float32"
}
func (e *StatementGetVarFloat32) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarFloat32) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarFloat32) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementGetVarFloat32) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func getVarFloat32Help() string {
	return `# GetVarFloat32 — Get Float32 Variable
...
|----------|--------|----------------------------------|
| Variable | string | Name of the int variable to read |
...
- Pair with **SetVarFloat32** to update the same variable elsewhere on the stage.
`
}
