...
func (e *StatementGetVarString) GetComment() string { return e.comment }

// SetComment sets the user comment.
// Português: Define o comentário do usuário.
func (e *StatementGetVarString) SetComment(c string) { e.comment = c }
...
func (e *StatementGetVarString) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementGetVarString) OpenInspect() { go e.showInspectOverlay() }
