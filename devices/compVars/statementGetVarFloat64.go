// /ide/devices/compVars/statementGetVarFloat64.go

package compVars

// statementGetVarFloat64.go — Get-variable device (float64).
//
...
//	│ VAR           float64 │  ← 18px header: "VAR" tag (left), type label (right)
//	├─────────────────────┤  ← divider
//	│                     │
//	│       counter   ◉   │  ← variable name, 16px bold, centered; ◉ = output connector
//	│                     │
//	└─────────────────────┘
//	getVarFloat641              ← editable label, 12px muted
//
...
// StatementGetVarFloat64 is a get-variable device for type float64.
// No inputs — single output connector that emits the variable's float64 value.
type StatementGetVarFloat64 struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementGetVarFloat64) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementGetVarFloat64) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementGetVarFloat64) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementGetVarFloat64) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementGetVarFloat64) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementGetVarFloat64) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementGetVarFloat64) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementGetVarFloat64) GetVarName() string             { return e.varName }
func (e *StatementGetVarFloat64) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementGetVarFloat64) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementGetVarFloat64) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementGetVarFloat64) renderSVG() string {
	w := e.width.GetFloat()
	...
	svg += fmt.Sprintf(
		`<text x="%.1f" y="%.1f" font-family="%s" font-size="%d" fill="%s" text-anchor="end" dominant-baseline="middle">float64</text>`,
...
func (e *StatementGetVarFloat64) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementGetVarFloat64) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("getVarFloat64")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[GetVarFloat64] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementGetVarFloat64) wireEvents() {
...
func (e *StatementGetVarFloat64) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[GetVarFloat64] delete: %s", e.id); e.Remove() }),
...
func (e *StatementGetVarFloat64) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementGetVarFloat64) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: getVarFloat64Help()},
		},
...
func (e *StatementGetVarFloat64) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementGetVarFloat64) ApplyProperties(values map[string]string) {
	if v, ok := values["varName"]; ok {
		e.varName = v
	}
	if lbl, ok := values["label"]; ok {
...
func (e *StatementGetVarFloat64) RegisterConnectors() {
...
func (e *StatementGetVarFloat64) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementGetVarFloat64) Get() *html.TagSvg { return nil }
func (e *StatementGetVarFloat64) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementGetVarFloat64) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat64) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementGetVarFloat64) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementGetVarFloat64) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementGetVarFloat64) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementGetVarFloat64) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementGetVarFloat64) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementGetVarFloat64) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat64) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementGetVarFloat64) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementGetVarFloat64) GetInitialized() bool   { return e.initialized }
func (e *StatementGetVarFloat64) GetID() string          { return e.id }
func (e *StatementGetVarFloat64) GetName() string        { return e.name }
func (e *StatementGetVarFloat64) GetSelected() bool      { return e.selected }
func (e *StatementGetVarFloat64) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementGetVarFloat64) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementGetVarFloat64) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementGetVarFloat64) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementGetVarFloat64) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementGetVarFloat64) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementGetVarFloat64) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementGetVarFloat64) GetStatus() int  { return e.iconStatus }
func (e *StatementGetVarFloat64) SetStatus(s int) { e.iconStatus = s }
func (e *StatementGetVarFloat64) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementGetVarFloat64) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementGetVarFloat64) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementGetVarFloat64) SetResizeEnable(_ bool) {
...
func (e *StatementGetVarFloat64) GetIconName() string     { return "GetVarFloat64" }
func (e *StatementGetVarFloat64) GetIconCategory() string { return "Variables" }

func (e *StatementGetVarFloat64) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementGetVarFloat64) GetDeviceType() string { return "StatementGetVarFloat64" }
func (e *StatementGetVarFloat64) GetProperties() map[string]interface{} {
...
// contribui.
func (e *StatementGetVarFloat64) GetVariableDecl() (name string, typ string) {
	return e.varName, "float64"
}
func (e *StatementGetVarFloat64) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarFloat64) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGetVarFloat64) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementGetVarFloat64) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func getVarFloat64Help() string {
	return `# GetVarFloat64 — Get Float64 Variable
...
- Pair with **SetVarFloat64** to update the same variable elsewhere on the stage.
`
}
