// /ide/devices/compVars/statementSetVarFloat32.go

package compVars

// statementSetVarFloat32.go — Set-variable device (float32).
//
...
//	│                     │
//	└─────────────────────┘
//	setVarFloat321              ← editable label, 12px muted
//
...
// numa variável de projeto do tipo float32. No codegen, um SetVar emite uma
...
// StatementSetVarFloat32 is a set-variable device for type float32.
// Single input connector "value" — assigns the wired value to the variable.
type StatementSetVarFloat32 struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementSetVarFloat32) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementSetVarFloat32) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementSetVarFloat32) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementSetVarFloat32) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementSetVarFloat32) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementSetVarFloat32) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementSetVarFloat32) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementSetVarFloat32) GetVarName() string             { return e.varName }
func (e *StatementSetVarFloat32) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementSetVarFloat32) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementSetVarFloat32) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementSetVarFloat32) renderSVG() string {
	w := e.width.GetFloat()
...
func (e *StatementSetVarFloat32) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementSetVarFloat32) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("setVarFloat32")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[SetVarFloat32] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementSetVarFloat32) wireEvents() {
...
func (e *StatementSetVarFloat32) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[SetVarFloat32] delete: %s", e.id); e.Remove() }),
...
func (e *StatementSetVarFloat32) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementSetVarFloat32) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: setVarFloat32Help()},
		},
...
func (e *StatementSetVarFloat32) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementSetVarFloat32) ApplyProperties(values map[string]string) {
	if v, ok := values["varName"]; ok {
		e.varName = v
	}
	if lbl, ok := values["label"]; ok {
...
func (e *StatementSetVarFloat32) RegisterConnectors() {
...
func (e *StatementSetVarFloat32) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementSetVarFloat32) Get() *html.TagSvg { return nil }
func (e *StatementSetVarFloat32) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementSetVarFloat32) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarFloat32) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementSetVarFloat32) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementSetVarFloat32) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementSetVarFloat32) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementSetVarFloat32) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementSetVarFloat32) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementSetVarFloat32) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarFloat32) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarFloat32) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementSetVarFloat32) GetInitialized() bool   { return e.initialized }
func (e *StatementSetVarFloat32) GetID() string          { return e.id }
func (e *StatementSetVarFloat32) GetName() string        { return e.name }
func (e *StatementSetVarFloat32) GetSelected() bool      { return e.selected }
func (e *StatementSetVarFloat32) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementSetVarFloat32) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementSetVarFloat32) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementSetVarFloat32) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementSetVarFloat32) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementSetVarFloat32) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementSetVarFloat32) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementSetVarFloat32) GetStatus() int  { return e.iconStatus }
func (e *StatementSetVarFloat32) SetStatus(s int) { e.iconStatus = s }
func (e *StatementSetVarFloat32) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementSetVarFloat32) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementSetVarFloat32) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementSetVarFloat32) SetResizeEnable(_ bool) {
...
func (e *StatementSetVarFloat32) GetIconName() string     { return "SetVarFloat32" }
func (e *StatementSetVarFloat32) GetIconCategory() string { return "Variables" }

func (e *StatementSetVarFloat32) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementSetVarFloat32) GetDeviceType() string { return "StatementSetVarFloat32" }
func (e *StatementSetVarFloat32) GetProperties() map[string]interface{} {
...
// contribui.
func (e *StatementSetVarFloat32) GetVariableDecl() (name string, typ string) {
	return e.varName, "float32"
}
func (e *StatementSetVarFloat32) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementSetVarFloat32) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementSetVarFloat32) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementSetVarFloat32) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func setVarFloat32Help() string {
	return `# SetVarFloat32 — Set Float32 Variable
...
|----------|--------|------------------------------------|
| Variable | string | Name of the float32 variable to write  |
...
- Wire a **Const**, **Add**, **Mul**, **Div**, or **GetVarFloat32** output into the input.
- Pair with **GetVarFloat32** to read the same variable elsewhere on the stage.
`
}
