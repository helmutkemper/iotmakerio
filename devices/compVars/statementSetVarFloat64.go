// /ide/devices/compVars/statementSetVarFloat64.go

package compVars

// statementSetVarFloat64.go — Set-variable device (float64).
//
...
//	│                     │
//	└─────────────────────┘
//	setVarFloat641              ← editable label, 12px muted
//
...
// numa variável de projeto do tipo float64. No codegen, um SetVar emite uma
...
// StatementSetVarFloat64 is a set-variable device for type float64.
// Single input connector "value" — assigns the wired value to the variable.
type StatementSetVarFloat64 struct {
	stage sprite.Stage
	elem  sprite.Element
...
func (e *StatementSetVarFloat64) SetStage(s sprite.Stage)               { e.stage = s }
func (e *StatementSetVarFloat64) SetWireManager(m *wire.Manager)        { e.wireMgr = m }
func (e *StatementSetVarFloat64) SetResizerButton(r block.ResizeButton) { e.resizerButton = r }
func (e *StatementSetVarFloat64) SetDraggerButton(_ block.ResizeButton) {}
func (e *StatementSetVarFloat64) SetGridAdjust(g grid.Adjust)           { e.gridAdjust = g }

// SetContextMenu injects the linear context menu controller.
// Português: Injeta o controller do menu de contexto linear.
func (e *StatementSetVarFloat64) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementSetVarFloat64) SetVarName(v string) {
	e.varName = v
	if e.initialized {
		go e.recacheSVG()
	}
}
func (e *StatementSetVarFloat64) GetVarName() string             { return e.varName }
func (e *StatementSetVarFloat64) SetOnRemove(fn func(id string)) { e.onRemove = fn }

// ── Lifecycle ─────────────────────────────────────────────────────────────────

func (e *StatementSetVarFloat64) Append() {
	if e.elem != nil {
		e.elem.SetVisible(true)
	}
}

func (e *StatementSetVarFloat64) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
func (e *StatementSetVarFloat64) renderSVG() string {
	w := e.width.GetFloat()
...
func (e *StatementSetVarFloat64) recacheSVG() {
	if e.elem != nil {
...
func (e *StatementSetVarFloat64) Init() (err error) {
	if e.stage == nil {
		return fmt.Errorf("stage not set")
	}
	e.id = rulesSequentialId.GetIdFromBase("setVarFloat64")
	e.resizeLocked = true
	if e.width == 0 {
	...
	if e.ctxMenu == nil {
		log.Printf("[SetVarFloat64] warning: no context menu set — menus disabled")
	}
	e.wireEvents()
	e.initialized = true
...
func (e *StatementSetVarFloat64) wireEvents() {
...
func (e *StatementSetVarFloat64) bodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() { log.Printf("[SetVarFloat64] delete: %s", e.id); e.Remove() }),
...
func (e *StatementSetVarFloat64) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementSetVarFloat64) inspectConfig() overlay.Config {
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			{Label: "Help", Type: overlay.TabMarkdown, Content: setVarFloat64Help()},
		},
...
func (e *StatementSetVarFloat64) GetInspectConfig() interface{} { return e.inspectConfig() }
func (e *StatementSetVarFloat64) ApplyProperties(values map[string]string) {
	if v, ok := values["varName"]; ok {
		e.varName = v
	}
	if lbl, ok := values["label"]; ok {
...
func (e *StatementSetVarFloat64) RegisterConnectors() {
...
func (e *StatementSetVarFloat64) SetName(n string)  { e.name = rulesSequentialId.GetIdFromBase(n) }
func (e *StatementSetVarFloat64) Get() *html.TagSvg { return nil }
func (e *StatementSetVarFloat64) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}
func (e *StatementSetVarFloat64) SetSize(w, h rulesDensity.Density) {
	e.width, e.height = w, h
	if e.elem != nil {
		e.elem.SetSizeD(w, h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarFloat64) GetWidth() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetWidthD()
	}
	return e.width
}
func (e *StatementSetVarFloat64) GetHeight() rulesDensity.Density { return e.height }
func (e *StatementSetVarFloat64) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
}
func (e *StatementSetVarFloat64) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
}
func (e *StatementSetVarFloat64) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, e.elem.GetYD())
	}
}
func (e *StatementSetVarFloat64) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(e.elem.GetXD(), y)
	}
}
func (e *StatementSetVarFloat64) SetWidth(w rulesDensity.Density) {
	e.width = w
	if e.elem != nil {
		e.elem.SetSizeD(w, e.height+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarFloat64) SetHeight(h rulesDensity.Density) {
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(e.elem.GetWidthD(), h+rulesDevice.KLabelHeight)
	}
}
func (e *StatementSetVarFloat64) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
...
func (e *StatementSetVarFloat64) GetInitialized() bool   { return e.initialized }
func (e *StatementSetVarFloat64) GetID() string          { return e.id }
func (e *StatementSetVarFloat64) GetName() string        { return e.name }
func (e *StatementSetVarFloat64) GetSelected() bool      { return e.selected }
func (e *StatementSetVarFloat64) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementSetVarFloat64) GetDragEnable() bool    { return e.dragEnabled }
func (e *StatementSetVarFloat64) GetDragBlocked() bool   { return e.dragLocked }
func (e *StatementSetVarFloat64) GetResizeEnable() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementSetVarFloat64) GetResize() bool        { return e.GetResizeEnable() }
func (e *StatementSetVarFloat64) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementSetVarFloat64) GetZIndex() int {
	if e.elem != nil {
		return e.elem.GetIndex()
	}
	return 0
}
func (e *StatementSetVarFloat64) GetStatus() int  { return e.iconStatus }
func (e *StatementSetVarFloat64) SetStatus(s int) { e.iconStatus = s }
func (e *StatementSetVarFloat64) SelectedInvert() { e.SetSelected(!e.selected) }

func (e *StatementSetVarFloat64) SetSelected(sel bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementSetVarFloat64) SetDragEnable(en bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementSetVarFloat64) SetResizeEnable(_ bool) {
...
func (e *StatementSetVarFloat64) GetIconName() string     { return "SetVarFloat64" }
func (e *StatementSetVarFloat64) GetIconCategory() string { return "Variables" }

func (e *StatementSetVarFloat64) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementSetVarFloat64) GetDeviceType() string { return "StatementSetVarFloat64" }
func (e *StatementSetVarFloat64) GetProperties() map[string]interface{} {
...
// contribui.
func (e *StatementSetVarFloat64) GetVariableDecl() (name string, typ string) {
	return e.varName, "float64"
}
func (e *StatementSetVarFloat64) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementSetVarFloat64) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementSetVarFloat64) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementSetVarFloat64) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// ── Help text ─────────────────────────────────────────────────────────────────

func setVarFloat64Help() string {
	return `# SetVarFloat64 — Set Float64 Variable
...
|----------|--------|------------------------------------|
| Variable | string | Name of the float64 variable to write  |
...
- Wire a **Const**, **Add**, **Mul**, **Div**, or **GetVarFloat64** output into the input.
- Pair with **GetVarFloat64** to read the same variable elsewhere on the stage.
`
}
