// devices/compLogic/statementEqualTo.go
//
...
type StatementEqualTo struct {
	...
	ornamentDraw *compare.OrnamentEqualTo
...
func (e *StatementEqualTo) SetStage(stage sprite.Stage) {
	e.stage = stage
}
...
func (e *StatementEqualTo) SetDataType(dt string) {
	if dt != "int" && dt != "float" && dt != "string" {
		log.Printf("[EqualTo] %s: invalid dataType %q, keeping %q", e.id, dt, e.dataType)
		return
	}
	if dt == e.dataType {
		return
	...
	log.Printf("[EqualTo] %s: dataType changed from %q to %q", e.id, old, dt)
}
...
func (e *StatementEqualTo) updateConnectorTypes() {
	if e.wireMgr == nil {
		return
	}
...
func (e *StatementEqualTo) IsHidden() bool { return e.hidden }

// SetHidden sets whether the label is hidden below the device.
func (e *StatementEqualTo) SetHidden(h bool) {
	e.hidden = h
	go func() {
...
func (e *StatementEqualTo) Append() {
...
func (e *StatementEqualTo) Remove() {
...
func (e *StatementEqualTo) SetOnRemove(fn func(id string)) {
	e.onRemove = fn
}

func (e *StatementEqualTo) SetResizerButton(resizeButton block.ResizeButton) {
	// [SPRITE] replaced: e.block.SetResizerButton(resizeButton)
	e.resizerButton = resizeButton
}

func (e *StatementEqualTo) SetGridAdjust(gridAdjust grid.Adjust) {
	e.gridAdjust = gridAdjust
}

func (e *StatementEqualTo) GetWidth() (width rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementEqualTo) GetHeight() (height rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementEqualTo) SetWarning(warning bool) {
	if !e.initialized {
		return
	}
...
func (e *StatementEqualTo) SetName(name string) {
	e.name = rulesSequentialId.GetIdFromBase(name)
}

func (e *StatementEqualTo) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementEqualTo) SetSize(width, height rulesDensity.Density) {
	e.width = width
	e.height = height
	if e.elem != nil {
...
func (e *StatementEqualTo) SetHexMenu(m *mainMenu.SpriteHexMenu) {
	e.hexMenu = m
}
...
func (e *StatementEqualTo) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
...
func (e *StatementEqualTo) getBodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		...
		}),
		{
			...
			ViewBox:         "0 0 512 512",
			HelpKey:         "helpMenuEqualToSettings",
...
// manual back button.
func (e *StatementEqualTo) settingsSubmenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementEqualTo) getInputXMenuItems() []contextMenu.Item {
	return mainMenu.ConnectorMenu(e.wireMgr, e.id, "inputX")
}

// getInputYMenuItems returns the linear menu for the inputY connector.
func (e *StatementEqualTo) getInputYMenuItems() []contextMenu.Item {
...
func (e *StatementEqualTo) getOutputMenuItems() []contextMenu.Item {
...
func (e *StatementEqualTo) getOutputMonitorSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementEqualTo) getOutputValueSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementEqualTo) getOutputFormatSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementEqualTo) Init() (err error) {
	...
	e.ornamentDraw = new(compare.OrnamentEqualTo)
...
func (e *StatementEqualTo) wireEvents() {
...
// RegisterConnectors registers all connection points of this StatementEqualTo
// with the wire.Manager. Must be called AFTER Init() (when e.elem exists).
//
// Português:
//
//	RegisterConnectors registra todos os pontos de conexão deste StatementEqualTo
//	no wire.Manager. Deve ser chamado APÓS Init() (quando e.elem existe).
func (e *StatementEqualTo) RegisterConnectors() {
...
func (e *StatementEqualTo) recacheOrnament() {
...
func (e *StatementEqualTo) injectLabelIntoSvg(svgXml string, ornH rulesDensity.Density) string {
...
func (e *StatementEqualTo) initWarningElement() {
...
func (e *StatementEqualTo) updateWarningPosition() {
...
func (e *StatementEqualTo) GetID() (id string) {
	return e.id
}

func (e *StatementEqualTo) SetSelected(selected bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementEqualTo) SetDragEnable(enabled bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementEqualTo) GetResizeEnable() (enabled bool) {
	if e.elem != nil {
...
func (e *StatementEqualTo) SetResizeEnable(enabled bool) {
	if e.resizeLocked {
		if e.elem != nil {
			e.elem.SetResizeEnable(false)
			e.elem.ShowResizeButtons(false)
...
func (e *StatementEqualTo) showInspectOverlay() {
...
func (e *StatementEqualTo) GetInspectConfig() interface{} {
	hiddenVal := "false"
	if e.hidden {
		hiddenVal = "true"
	}
	...
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			},
			{
				...
				ContentURL: "/help/devices/logic/statementEqualTo.md", // todo: to rules
			},
			{
...
func (e *StatementEqualTo) codePreview() string {
	code := ""
	if e.comment != "" {
		// Multi-line comments
...
// Implements scene.Inspectable.
func (e *StatementEqualTo) ApplyProperties(values map[string]string) {
	changed := false

	if v, ok := values["label"]; ok && v != "" && v != e.label {
		e.label = v
		changed = true
		log.Printf("[EqualTo] %s: label set to %q", e.id, v)
	}

	if v, ok := values["comment"]; ok && v != e.comment {
		e.comment = v
		log.Printf("[EqualTo] %s: comment set to %q", e.id, v)
	}
	...
	if v, ok := values["hidden"]; ok {
		...
		if h != e.hidden {
			e.SetHidden(h)
			log.Printf("[EqualTo] %s: hidden set to %v", e.id, h)
		}
	}
...
func (e *StatementEqualTo) GetProperties() map[string]interface{} {
...
func (e *StatementEqualTo) GetDeviceType() string { return "StatementEqualTo" }

func (e *StatementEqualTo) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementEqualTo) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementEqualTo) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementEqualTo) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// MoveBy shifts the device by (dx, dy) and updates all side effects.
// Implements scene.Movable — used by container drag logic.
func (e *StatementEqualTo) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementEqualTo) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementEqualTo) OpenInspect() { go e.showInspectOverlay() }
