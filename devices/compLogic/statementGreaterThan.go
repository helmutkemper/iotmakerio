// devices/compLogic/statementGreaterThan.go
//
...
type StatementGreaterThan struct {
	...
	ornamentDraw *compare.OrnamentGreaterThan
...
func (e *StatementGreaterThan) SetStage(stage sprite.Stage) {
	e.stage = stage
}
...
func (e *StatementGreaterThan) SetWireManager(mgr *wire.Manager) {
	e.wireMgr = mgr
}

// SetCanvasEl stores the canvas DOM element for positioning overlay inputs.
func (e *StatementGreaterThan) SetCanvasEl(el js.Value) {
	e.canvasEl = el
}

// GetLabel returns the current editable label. Implements scene.Labeled.
func (e *StatementGreaterThan) GetLabel() string { return e.label }

// SetLabel updates the label and re-renders the SVG.
func (e *StatementGreaterThan) SetLabel(label string) {
	e.label = label
	go e.recacheOrnament()
}

// GetComment returns the user comment for code generation.
func (e *StatementGreaterThan) GetComment() string { return e.comment }

// SetComment sets the comment that appears in generated code.
func (e *StatementGreaterThan) SetComment(c string) { e.comment = c }

// GetDataType returns the current data type (int, float, string).
func (e *StatementGreaterThan) GetDataType() string { return e.dataType }
...
func (e *StatementGreaterThan) SetDataType(dt string) {
	if dt != "int" && dt != "float" && dt != "string" {
		log.Printf("[GreaterThan] %s: invalid dataType %q, keeping %q", e.id, dt, e.dataType)
		return
	}
	if dt == e.dataType {
		return
	...
	log.Printf("[GreaterThan] %s: dataType changed from %q to %q", e.id, old, dt)
}
...
func (e *StatementGreaterThan) updateConnectorTypes() {
	if e.wireMgr == nil {
		return
	}
...
func (e *StatementGreaterThan) IsHidden() bool { return e.hidden }

// SetHidden sets whether the label is hidden below the device.
func (e *StatementGreaterThan) SetHidden(h bool) {
	e.hidden = h
	go func() {
...
func (e *StatementGreaterThan) Append() {
...
func (e *StatementGreaterThan) Remove() {
...
func (e *StatementGreaterThan) SetOnRemove(fn func(id string)) {
	e.onRemove = fn
}

func (e *StatementGreaterThan) SetResizerButton(resizeButton block.ResizeButton) {
	// [SPRITE] replaced: e.block.SetResizerButton(resizeButton)
	e.resizerButton = resizeButton
}

func (e *StatementGreaterThan) SetGridAdjust(gridAdjust grid.Adjust) {
	e.gridAdjust = gridAdjust
}

func (e *StatementGreaterThan) GetWidth() (width rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementGreaterThan) GetHeight() (height rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementGreaterThan) SetWarning(warning bool) {
	if !e.initialized {
		return
	}
...
func (e *StatementGreaterThan) SetName(name string) {
	e.name = rulesSequentialId.GetIdFromBase(name)
}

func (e *StatementGreaterThan) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementGreaterThan) SetSize(width, height rulesDensity.Density) {
	e.width = width
	e.height = height
	if e.elem != nil {
...
func (e *StatementGreaterThan) SetHexMenu(m *mainMenu.SpriteHexMenu) {
	e.hexMenu = m
}
...
func (e *StatementGreaterThan) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
...
func (e *StatementGreaterThan) getBodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		...
		}),
		{
			...
			ViewBox:         "0 0 512 512",
			HelpKey:         "helpMenuGreaterThanSettings",
...
// manual back button.
func (e *StatementGreaterThan) settingsSubmenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementGreaterThan) getInputXMenuItems() []contextMenu.Item {
	return mainMenu.ConnectorMenu(e.wireMgr, e.id, "inputX")
}

// getInputYMenuItems returns the linear menu for the inputY connector.
func (e *StatementGreaterThan) getInputYMenuItems() []contextMenu.Item {
...
func (e *StatementGreaterThan) getOutputMenuItems() []contextMenu.Item {
...
func (e *StatementGreaterThan) getOutputMonitorSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementGreaterThan) getOutputValueSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementGreaterThan) getOutputFormatSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementGreaterThan) Init() (err error) {
	...
	e.ornamentDraw = new(compare.OrnamentGreaterThan)
...
func (e *StatementGreaterThan) wireEvents() {
...
// RegisterConnectors registers all connection points of this StatementGreaterThan
// with the wire.Manager. Must be called AFTER Init() (when e.elem exists).
//
// Português:
//
//	RegisterConnectors registra todos os pontos de conexão deste StatementGreaterThan
//	no wire.Manager. Deve ser chamado APÓS Init() (quando e.elem existe).
func (e *StatementGreaterThan) RegisterConnectors() {
...
func (e *StatementGreaterThan) recacheOrnament() {
...
func (e *StatementGreaterThan) injectLabelIntoSvg(svgXml string, ornH rulesDensity.Density) string {
...
func (e *StatementGreaterThan) initWarningElement() {
...
func (e *StatementGreaterThan) updateWarningPosition() {
...
func (e *StatementGreaterThan) GetID() (id string) {
	return e.id
}

func (e *StatementGreaterThan) SetSelected(selected bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementGreaterThan) SetDragEnable(enabled bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementGreaterThan) GetResizeEnable() (enabled bool) {
	if e.elem != nil {
...
func (e *StatementGreaterThan) SetResizeEnable(enabled bool) {
	if e.resizeLocked {
		if e.elem != nil {
			e.elem.SetResizeEnable(false)
			e.elem.ShowResizeButtons(false)
...
func (e *StatementGreaterThan) showInspectOverlay() {
...
func (e *StatementGreaterThan) GetInspectConfig() interface{} {
	hiddenVal := "false"
	if e.hidden {
		hiddenVal = "true"
	}
	...
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			},
			{
				...
				ContentURL: "/help/devices/logic/statementGreaterThan.md", // todo: to rules
			},
			{
...
func (e *StatementGreaterThan) codePreview() string {
	code := ""
	if e.comment != "" {
		// Multi-line comments
...
// Implements scene.Inspectable.
func (e *StatementGreaterThan) ApplyProperties(values map[string]string) {
	changed := false

	if v, ok := values["label"]; ok && v != "" && v != e.label {
		e.label = v
		changed = true
		log.Printf("[GreaterThan] %s: label set to %q", e.id, v)
	}

	if v, ok := values["comment"]; ok && v != e.comment {
		e.comment = v
		log.Printf("[GreaterThan] %s: comment set to %q", e.id, v)
	}
	...
	if v, ok := values["hidden"]; ok {
		...
		if h != e.hidden {
			e.SetHidden(h)
			log.Printf("[GreaterThan] %s: hidden set to %v", e.id, h)
		}
	}
...
func (e *StatementGreaterThan) GetProperties() map[string]interface{} {
...
func (e *StatementGreaterThan) GetDeviceType() string { return "StatementGreaterThan" }

func (e *StatementGreaterThan) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGreaterThan) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGreaterThan) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementGreaterThan) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// MoveBy shifts the device by (dx, dy) and updates all side effects.
// Implements scene.Movable — used by container drag logic.
func (e *StatementGreaterThan) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementGreaterThan) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementGreaterThan) OpenInspect() { go e.showInspectOverlay() }
