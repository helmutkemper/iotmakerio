// devices/compLogic/statementLessThan.go
//
...
type StatementLessThan struct {
	...
	ornamentDraw *compare.OrnamentLessThan
...
func (e *StatementLessThan) SetStage(stage sprite.Stage) {
	e.stage = stage
}
...
func (e *StatementLessThan) SetWireManager(mgr *wire.Manager) {
	e.wireMgr = mgr
}

// SetCanvasEl stores the canvas DOM element for positioning overlay inputs.
func (e *StatementLessThan) SetCanvasEl(el js.Value) {
	e.canvasEl = el
}

// GetLabel returns the current editable label. Implements scene.Labeled.
func (e *StatementLessThan) GetLabel() string { return e.label }

// SetLabel updates the label and re-renders the SVG.
func (e *StatementLessThan) SetLabel(label string) {
	e.label = label
	go e.recacheOrnament()
}

// GetComment returns the user comment for code generation.
func (e *StatementLessThan) GetComment() string { return e.comment }

// SetComment sets the comment that appears in generated code.
func (e *StatementLessThan) SetComment(c string) { e.comment = c }

// GetDataType returns the current data type (int, float, string).
func (e *StatementLessThan) GetDataType() string { return e.dataType }
...
func (e *StatementLessThan) SetDataType(dt string) {
	if dt != "int" && dt != "float" && dt != "string" {
		log.Printf("[LessThan] %s: invalid dataType %q, keeping %q", e.id, dt, e.dataType)
		return
	}
	if dt == e.dataType {
		return
	...
	log.Printf("[LessThan] %s: dataType changed from %q to %q", e.id, old, dt)
}
...
func (e *StatementLessThan) updateConnectorTypes() {
	if e.wireMgr == nil {
		return
	}
...
func (e *StatementLessThan) IsHidden() bool { return e.hidden }

// SetHidden sets whether the label is hidden below the device.
func (e *StatementLessThan) SetHidden(h bool) {
	e.hidden = h
	go func() {
...
func (e *StatementLessThan) Append() {
...
func (e *StatementLessThan) Remove() {
...
func (e *StatementLessThan) SetOnRemove(fn func(id string)) {
	e.onRemove = fn
}

func (e *StatementLessThan) SetResizerButton(resizeButton block.ResizeButton) {
	// [SPRITE] replaced: e.block.SetResizerButton(resizeButton)
	e.resizerButton = resizeButton
}

func (e *StatementLessThan) SetGridAdjust(gridAdjust grid.Adjust) {
	e.gridAdjust = gridAdjust
}

func (e *StatementLessThan) GetWidth() (width rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementLessThan) GetHeight() (height rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementLessThan) SetWarning(warning bool) {
	if !e.initialized {
		return
	}
...
func (e *StatementLessThan) SetName(name string) {
	e.name = rulesSequentialId.GetIdFromBase(name)
}

func (e *StatementLessThan) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementLessThan) SetSize(width, height rulesDensity.Density) {
	e.width = width
	e.height = height
	if e.elem != nil {
...
func (e *StatementLessThan) SetHexMenu(m *mainMenu.SpriteHexMenu) {
	e.hexMenu = m
}
...
func (e *StatementLessThan) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
...
func (e *StatementLessThan) getBodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		...
		}),
		{
			...
			ViewBox:         "0 0 512 512",
			HelpKey:         "helpMenuLessThanSettings",
...
// manual back button.
func (e *StatementLessThan) settingsSubmenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThan) getInputXMenuItems() []contextMenu.Item {
	return mainMenu.ConnectorMenu(e.wireMgr, e.id, "inputX")
}

// getInputYMenuItems returns the linear menu for the inputY connector.
func (e *StatementLessThan) getInputYMenuItems() []contextMenu.Item {
...
func (e *StatementLessThan) getOutputMenuItems() []contextMenu.Item {
...
func (e *StatementLessThan) getOutputMonitorSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThan) getOutputValueSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThan) getOutputFormatSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThan) Init() (err error) {
	...
	e.ornamentDraw = new(compare.OrnamentLessThan)
...
func (e *StatementLessThan) wireEvents() {
...
// RegisterConnectors registers all connection points of this StatementLessThan
// with the wire.Manager. Must be called AFTER Init() (when e.elem exists).
//
// Português:
//
//	RegisterConnectors registra todos os pontos de conexão deste StatementLessThan
//	no wire.Manager. Deve ser chamado APÓS Init() (quando e.elem existe).
func (e *StatementLessThan) RegisterConnectors() {
...
func (e *StatementLessThan) recacheOrnament() {
...
func (e *StatementLessThan) injectLabelIntoSvg(svgXml string, ornH rulesDensity.Density) string {
...
func (e *StatementLessThan) initWarningElement() {
...
func (e *StatementLessThan) updateWarningPosition() {
...
func (e *StatementLessThan) GetID() (id string) {
	return e.id
}

func (e *StatementLessThan) SetSelected(selected bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementLessThan) SetDragEnable(enabled bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementLessThan) GetResizeEnable() (enabled bool) {
	if e.elem != nil {
...
func (e *StatementLessThan) SetResizeEnable(enabled bool) {
	if e.resizeLocked {
		if e.elem != nil {
			e.elem.SetResizeEnable(false)
			e.elem.ShowResizeButtons(false)
...
func (e *StatementLessThan) showInspectOverlay() {
...
func (e *StatementLessThan) GetInspectConfig() interface{} {
	hiddenVal := "false"
	if e.hidden {
		hiddenVal = "true"
	}
	...
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			},
			{
				...
				ContentURL: "/help/devices/logic/statementLessThan.md", // todo: to rules
			},
			{
...
func (e *StatementLessThan) codePreview() string {
	code := ""
	if e.comment != "" {
		// Multi-line comments
...
// Implements scene.Inspectable.
func (e *StatementLessThan) ApplyProperties(values map[string]string) {
	changed := false

	if v, ok := values["label"]; ok && v != "" && v != e.label {
		e.label = v
		changed = true
		log.Printf("[LessThan] %s: label set to %q", e.id, v)
	}

	if v, ok := values["comment"]; ok && v != e.comment {
		e.comment = v
		log.Printf("[LessThan] %s: comment set to %q", e.id, v)
	}
	...
	if v, ok := values["hidden"]; ok {
		...
		if h != e.hidden {
			e.SetHidden(h)
			log.Printf("[LessThan] %s: hidden set to %v", e.id, h)
		}
	}
...
func (e *StatementLessThan) GetProperties() map[string]interface{} {
...
func (e *StatementLessThan) GetDeviceType() string { return "StatementLessThan" }

func (e *StatementLessThan) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLessThan) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLessThan) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementLessThan) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// MoveBy shifts the device by (dx, dy) and updates all side effects.
// Implements scene.Movable — used by container drag logic.
func (e *StatementLessThan) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLessThan) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementLessThan) OpenInspect() { go e.showInspectOverlay() }
