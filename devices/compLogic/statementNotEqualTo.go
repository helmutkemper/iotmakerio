// devices/compLogic/statementNotEqualTo.go
//
...
type StatementNotEqualTo struct {
	...
	ornamentDraw *compare.OrnamentNotEqualTo
...
func (e *StatementNotEqualTo) SetStage(stage sprite.Stage) {
	e.stage = stage
}
...
func (e *StatementNotEqualTo) SetWireManager(mgr *wire.Manager) {
	e.wireMgr = mgr
}

// SetCanvasEl stores the canvas DOM element for positioning overlay inputs.
func (e *StatementNotEqualTo) SetCanvasEl(el js.Value) {
	e.canvasEl = el
}

// GetLabel returns the current editable label. Implements scene.Labeled.
func (e *StatementNotEqualTo) GetLabel() string { return e.label }

// SetLabel updates the label and re-renders the SVG.
func (e *StatementNotEqualTo) SetLabel(label string) {
	e.label = label
	go e.recacheOrnament()
}

// GetComment returns the user comment for code generation.
func (e *StatementNotEqualTo) GetComment() string { return e.comment }

// SetComment sets the comment that appears in generated code.
func (e *StatementNotEqualTo) SetComment(c string) { e.comment = c }

// GetDataType returns the current data type (int, float, string).
func (e *StatementNotEqualTo) GetDataType() string { return e.dataType }
...
func (e *StatementNotEqualTo) SetDataType(dt string) {
	if dt != "int" && dt != "float" && dt != "string" {
		log.Printf("[NotEqualTo] %s: invalid dataType %q, keeping %q", e.id, dt, e.dataType)
		return
	}
	if dt == e.dataType {
		return
	...
	log.Printf("[NotEqualTo] %s: dataType changed from %q to %q", e.id, old, dt)
}
...
func (e *StatementNotEqualTo) updateConnectorTypes() {
	if e.wireMgr == nil {
		return
	}
...
func (e *StatementNotEqualTo) IsHidden() bool { return e.hidden }

// SetHidden sets whether the label is hidden below the device.
func (e *StatementNotEqualTo) SetHidden(h bool) {
	e.hidden = h
	go func() {
...
func (e *StatementNotEqualTo) Append() {
...
func (e *StatementNotEqualTo) Remove() {
...
func (e *StatementNotEqualTo) SetOnRemove(fn func(id string)) {
	e.onRemove = fn
}

func (e *StatementNotEqualTo) SetResizerButton(resizeButton block.ResizeButton) {
	// [SPRITE] replaced: e.block.SetResizerButton(resizeButton)
	e.resizerButton = resizeButton
}

func (e *StatementNotEqualTo) SetGridAdjust(gridAdjust grid.Adjust) {
	e.gridAdjust = gridAdjust
}

func (e *StatementNotEqualTo) GetWidth() (width rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementNotEqualTo) GetHeight() (height rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementNotEqualTo) SetWarning(warning bool) {
	if !e.initialized {
		return
	}
...
func (e *StatementNotEqualTo) SetName(name string) {
	e.name = rulesSequentialId.GetIdFromBase(name)
}

func (e *StatementNotEqualTo) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementNotEqualTo) SetSize(width, height rulesDensity.Density) {
	e.width = width
	e.height = height
	if e.elem != nil {
...
func (e *StatementNotEqualTo) SetHexMenu(m *mainMenu.SpriteHexMenu) {
	e.hexMenu = m
}
...
func (e *StatementNotEqualTo) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
...
func (e *StatementNotEqualTo) getBodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		...
		}),
		{
			...
			ViewBox:         "0 0 512 512",
			HelpKey:         "helpMenuNotEqualToSettings",
...
// manual back button.
func (e *StatementNotEqualTo) settingsSubmenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementNotEqualTo) getInputXMenuItems() []contextMenu.Item {
	return mainMenu.ConnectorMenu(e.wireMgr, e.id, "inputX")
}

// getInputYMenuItems returns the linear menu for the inputY connector.
func (e *StatementNotEqualTo) getInputYMenuItems() []contextMenu.Item {
...
func (e *StatementNotEqualTo) getOutputMenuItems() []contextMenu.Item {
...
func (e *StatementNotEqualTo) getOutputMonitorSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementNotEqualTo) getOutputValueSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementNotEqualTo) getOutputFormatSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementNotEqualTo) Init() (err error) {
	...
	e.ornamentDraw = new(compare.OrnamentNotEqualTo)
...
func (e *StatementNotEqualTo) wireEvents() {
...
// RegisterConnectors registers all connection points of this StatementNotEqualTo
// with the wire.Manager. Must be called AFTER Init() (when e.elem exists).
//
// Português:
//
//	RegisterConnectors registra todos os pontos de conexão deste StatementNotEqualTo
//	no wire.Manager. Deve ser chamado APÓS Init() (quando e.elem existe).
func (e *StatementNotEqualTo) RegisterConnectors() {
...
func (e *StatementNotEqualTo) recacheOrnament() {
...
func (e *StatementNotEqualTo) injectLabelIntoSvg(svgXml string, ornH rulesDensity.Density) string {
...
func (e *StatementNotEqualTo) initWarningElement() {
...
func (e *StatementNotEqualTo) updateWarningPosition() {
...
func (e *StatementNotEqualTo) GetID() (id string) {
	return e.id
}

func (e *StatementNotEqualTo) SetSelected(selected bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementNotEqualTo) SetDragEnable(enabled bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementNotEqualTo) GetResizeEnable() (enabled bool) {
	if e.elem != nil {
...
func (e *StatementNotEqualTo) SetResizeEnable(enabled bool) {
	if e.resizeLocked {
		if e.elem != nil {
			e.elem.SetResizeEnable(false)
			e.elem.ShowResizeButtons(false)
...
func (e *StatementNotEqualTo) showInspectOverlay() {
...
func (e *StatementNotEqualTo) GetInspectConfig() interface{} {
	hiddenVal := "false"
	if e.hidden {
		hiddenVal = "true"
	}
	...
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			},
			{
				...
				ContentURL: "/help/devices/logic/statementNotEqualTo.md", // todo: to rules
			},
			{
...
func (e *StatementNotEqualTo) codePreview() string {
	code := ""
	if e.comment != "" {
		// Multi-line comments
...
// Implements scene.Inspectable.
func (e *StatementNotEqualTo) ApplyProperties(values map[string]string) {
	changed := false

	if v, ok := values["label"]; ok && v != "" && v != e.label {
		e.label = v
		changed = true
		log.Printf("[NotEqualTo] %s: label set to %q", e.id, v)
	}

	if v, ok := values["comment"]; ok && v != e.comment {
		e.comment = v
		log.Printf("[NotEqualTo] %s: comment set to %q", e.id, v)
	}
	...
	if v, ok := values["hidden"]; ok {
		...
		if h != e.hidden {
			e.SetHidden(h)
			log.Printf("[NotEqualTo] %s: hidden set to %v", e.id, h)
		}
	}
...
func (e *StatementNotEqualTo) GetProperties() map[string]interface{} {
...
func (e *StatementNotEqualTo) GetDeviceType() string { return "StatementNotEqualTo" }

func (e *StatementNotEqualTo) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementNotEqualTo) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementNotEqualTo) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementNotEqualTo) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// MoveBy shifts the device by (dx, dy) and updates all side effects.
// Implements scene.Movable — used by container drag logic.
func (e *StatementNotEqualTo) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementNotEqualTo) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementNotEqualTo) OpenInspect() { go e.showInspectOverlay() }
