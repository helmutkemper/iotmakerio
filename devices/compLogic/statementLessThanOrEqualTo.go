// devices/compLogic/statementLessThanOrEqualTo.go
//
...
type StatementLessThanOrEqualTo struct {
	...
	ornamentDraw *compare.OrnamentLessThanOrEqualTo
...
func (e *StatementLessThanOrEqualTo) SetStage(stage sprite.Stage) {
	e.stage = stage
}
...
func (e *StatementLessThanOrEqualTo) SetWireManager(mgr *wire.Manager) {
	e.wireMgr = mgr
}

// SetCanvasEl stores the canvas DOM element for positioning overlay inputs.
func (e *StatementLessThanOrEqualTo) SetCanvasEl(el js.Value) {
	e.canvasEl = el
}

// GetLabel returns the current editable label. Implements scene.Labeled.
func (e *StatementLessThanOrEqualTo) GetLabel() string { return e.label }

// SetLabel updates the label and re-renders the SVG.
func (e *StatementLessThanOrEqualTo) SetLabel(label string) {
	e.label = label
	go e.recacheOrnament()
}

// GetComment returns the user comment for code generation.
func (e *StatementLessThanOrEqualTo) GetComment() string { return e.comment }

// SetComment sets the comment that appears in generated code.
func (e *StatementLessThanOrEqualTo) SetComment(c string) { e.comment = c }

// GetDataType returns the current data type (int, float, string).
func (e *StatementLessThanOrEqualTo) GetDataType() string { return e.dataType }
...
func (e *StatementLessThanOrEqualTo) SetDataType(dt string) {
	if dt != "int" && dt != "float" && dt != "string" {
		log.Printf("[LessThanOrEqualTo] %s: invalid dataType %q, keeping %q", e.id, dt, e.dataType)
		return
	}
	if dt == e.dataType {
		return
	...
	log.Printf("[LessThanOrEqualTo] %s: dataType changed from %q to %q", e.id, old, dt)
}
...
func (e *StatementLessThanOrEqualTo) updateConnectorTypes() {
	if e.wireMgr == nil {
		return
	}
...
func (e *StatementLessThanOrEqualTo) IsHidden() bool { return e.hidden }

// SetHidden sets whether the label is hidden below the device.
func (e *StatementLessThanOrEqualTo) SetHidden(h bool) {
	e.hidden = h
	go func() {
...
func (e *StatementLessThanOrEqualTo) Append() {
...
func (e *StatementLessThanOrEqualTo) Remove() {
...
func (e *StatementLessThanOrEqualTo) SetOnRemove(fn func(id string)) {
	e.onRemove = fn
}

func (e *StatementLessThanOrEqualTo) SetResizerButton(resizeButton block.ResizeButton) {
	// [SPRITE] replaced: e.block.SetResizerButton(resizeButton)
	e.resizerButton = resizeButton
}

func (e *StatementLessThanOrEqualTo) SetGridAdjust(gridAdjust grid.Adjust) {
	e.gridAdjust = gridAdjust
}

func (e *StatementLessThanOrEqualTo) GetWidth() (width rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementLessThanOrEqualTo) GetHeight() (height rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementLessThanOrEqualTo) SetWarning(warning bool) {
	if !e.initialized {
		return
	}
...
func (e *StatementLessThanOrEqualTo) SetName(name string) {
	e.name = rulesSequentialId.GetIdFromBase(name)
}

func (e *StatementLessThanOrEqualTo) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
...
func (e *StatementLessThanOrEqualTo) SetSize(width, height rulesDensity.Density) {
	e.width = width
	e.height = height
	if e.elem != nil {
...
func (e *StatementLessThanOrEqualTo) SetHexMenu(m *mainMenu.SpriteHexMenu) {
	e.hexMenu = m
}
...
func (e *StatementLessThanOrEqualTo) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
...
func (e *StatementLessThanOrEqualTo) getBodyMenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		...
		}),
		{
			...
			ViewBox:         "0 0 512 512",
			HelpKey:         "helpMenuLessThanOrEqualToSettings",
...
// manual back button.
func (e *StatementLessThanOrEqualTo) settingsSubmenuItems() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThanOrEqualTo) getInputXMenuItems() []contextMenu.Item {
	return mainMenu.ConnectorMenu(e.wireMgr, e.id, "inputX")
}

// getInputYMenuItems returns the linear menu for the inputY connector.
func (e *StatementLessThanOrEqualTo) getInputYMenuItems() []contextMenu.Item {
...
func (e *StatementLessThanOrEqualTo) getOutputMenuItems() []contextMenu.Item {
...
func (e *StatementLessThanOrEqualTo) getOutputMonitorSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThanOrEqualTo) getOutputValueSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThanOrEqualTo) getOutputFormatSubmenu() []contextMenu.Item {
	return []contextMenu.Item{
		{
...
func (e *StatementLessThanOrEqualTo) Init() (err error) {
	...
	e.ornamentDraw = new(compare.OrnamentLessThanOrEqualTo)
...
func (e *StatementLessThanOrEqualTo) wireEvents() {
...
// RegisterConnectors registers all connection points of this StatementLessThanOrEqualTo
// with the wire.Manager. Must be called AFTER Init() (when e.elem exists).
//
// Português:
//
//	RegisterConnectors registra todos os pontos de conexão deste StatementLessThanOrEqualTo
//	no wire.Manager. Deve ser chamado APÓS Init() (quando e.elem existe).
func (e *StatementLessThanOrEqualTo) RegisterConnectors() {
...
func (e *StatementLessThanOrEqualTo) recacheOrnament() {
...
func (e *StatementLessThanOrEqualTo) injectLabelIntoSvg(svgXml string, ornH rulesDensity.Density) string {
...
func (e *StatementLessThanOrEqualTo) initWarningElement() {
...
func (e *StatementLessThanOrEqualTo) updateWarningPosition() {
...
func (e *StatementLessThanOrEqualTo) GetID() (id string) {
	return e.id
}

func (e *StatementLessThanOrEqualTo) SetSelected(selected bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementLessThanOrEqualTo) SetDragEnable(enabled bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementLessThanOrEqualTo) GetResizeEnable() (enabled bool) {
	if e.elem != nil {
...
func (e *StatementLessThanOrEqualTo) SetResizeEnable(enabled bool) {
	if e.resizeLocked {
		if e.elem != nil {
			e.elem.SetResizeEnable(false)
			e.elem.ShowResizeButtons(false)
...
func (e *StatementLessThanOrEqualTo) showInspectOverlay() {
...
func (e *StatementLessThanOrEqualTo) GetInspectConfig() interface{} {
	hiddenVal := "false"
	if e.hidden {
		hiddenVal = "true"
	}
	...
	return overlay.Config{
		...
		Tabs: []overlay.Tab{
			...
			},
			{
				...
				ContentURL: "/help/devices/logic/statementLessThanOrEqualTo.md", // todo: to rules
			},
			{
...
func (e *StatementLessThanOrEqualTo) codePreview() string {
	code := ""
	if e.comment != "" {
		// Multi-line comments
...
// Implements scene.Inspectable.
func (e *StatementLessThanOrEqualTo) ApplyProperties(values map[string]string) {
	changed := false

	if v, ok := values["label"]; ok && v != "" && v != e.label {
		e.label = v
		changed = true
		log.Printf("[LessThanOrEqualTo] %s: label set to %q", e.id, v)
	}

	if v, ok := values["comment"]; ok && v != e.comment {
		e.comment = v
		log.Printf("[LessThanOrEqualTo] %s: comment set to %q", e.id, v)
	}
	...
	if v, ok := values["hidden"]; ok {
		...
		if h != e.hidden {
			e.SetHidden(h)
			log.Printf("[LessThanOrEqualTo] %s: hidden set to %v", e.id, h)
		}
	}
...
func (e *StatementLessThanOrEqualTo) GetProperties() map[string]interface{} {
...
func (e *StatementLessThanOrEqualTo) GetDeviceType() string { return "StatementLessThanOrEqualTo" }

func (e *StatementLessThanOrEqualTo) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLessThanOrEqualTo) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLessThanOrEqualTo) GetKind() scenegraph.Kind { return scenegraph.KindSimple }
func (e *StatementLessThanOrEqualTo) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// MoveBy shifts the device by (dx, dy) and updates all side effects.
// Implements scene.Movable — used by container drag logic.
func (e *StatementLessThanOrEqualTo) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLessThanOrEqualTo) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }
...
func (e *StatementLessThanOrEqualTo) OpenInspect() { go e.showInspectOverlay() }
