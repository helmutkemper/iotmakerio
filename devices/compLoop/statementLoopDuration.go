// /ide/devices/compLoop/statementLoopDuration.go
// SPDX-FileCopyrightText: 2026 Helmut Kemper
// SPDX-License-Identifier: AGPL-3.0-only

package compLoop

// statementLoopDuration.go — Timed loop container device.
//
// English:
//
//	A Complex device (kind = KindComplex) that provides a visual
//	timed "for" loop on the stage. The ornament is drawn by
//	doubleLoopArrowHourglass and carries an interval button (a
//	time.Duration input connector) in the bottom-right corner. Each
//	iteration ends with time.Sleep(interval) — there is no stop
//	condition; the loop is infinite unless broken externally.
//
...
import (
	...
	"github.com/helmutkemper/iotmakerio/ornament/doubleLoopArrowHourglass"
...
type StatementLoopDuration struct {
	// Sprite/DOM ----------------------------------------------------
	stage sprite.Stage
	elem  sprite.Element
	...
	ornamentDraw     *doubleLoopArrowHourglass.DoubleLoopArrowHourglass
	ornamentDrawIcon *doubleLoopArrowHourglass.DoubleLoopArrowHourglass
...
func (e *StatementLoopDuration) SetStage(stage sprite.Stage)       { e.stage = stage }
func (e *StatementLoopDuration) SetSceneMgr(mgr *scene.Serializer) { e.sceneMgr = mgr }

// SetContextMenu injects the linear context menu controller.
func (e *StatementLoopDuration) SetContextMenu(c *contextMenu.Controller) {
	e.ctxMenu = c
}
func (e *StatementLoopDuration) SetWireManager(mgr *wire.Manager)       { e.wireMgr = mgr }
func (e *StatementLoopDuration) SetCanvasEl(el js.Value)                { e.canvasEl = el }
func (e *StatementLoopDuration) SetResizerButton(rb block.ResizeButton) { e.resizerButton = rb }
func (e *StatementLoopDuration) SetDraggerButton(_ block.ResizeButton)  {}
func (e *StatementLoopDuration) SetGridAdjust(ga grid.Adjust)           { e.gridAdjust = ga }
func (e *StatementLoopDuration) SetOnRemove(fn func(id string))         { e.onRemove = fn }
...
func (e *StatementLoopDuration) SetSceneNotify(fn func()) { e.sceneNotify = fn }

// =====================================================================
//  Lifecycle
// =====================================================================

func (e *StatementLoopDuration) Append() {
	if e.elem != nil {
...
func (e *StatementLoopDuration) Remove() {
	if e.onRemove != nil {
		e.onRemove(e.id)
	}
	if e.wireMgr != nil {
...
// scene.Kinded.
func (e *StatementLoopDuration) GetKind() scenegraph.Kind { return scenegraph.KindComplex }

// GetContainerPadding returns the padding used to derive border 3 from
// border 1. Satisfies scene.Padded.
func (e *StatementLoopDuration) GetContainerPadding() rulesContainer.Padding {
...
func (e *StatementLoopDuration) GetDeviceType() string { return "StatementLoopDuration" }

func (e *StatementLoopDuration) GetOuterBBox() scene.Rect {
	if e.elem == nil {
		return scene.Rect{}
	}
...
func (e *StatementLoopDuration) GetInnerBBox() *scene.Rect {
	if e.elem == nil {
		return nil
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLoopDuration) MoveBy(dx, dy float64) {
	if e.elem == nil {
		return
	}
	x, y := e.elem.GetPosition()
...
func (e *StatementLoopDuration) RefreshVisual() {
	e.recacheOrnament()
	if e.wireMgr != nil {
		e.wireMgr.RecalculateForElement(e.id)
	}
...
func (e *StatementLoopDuration) Get() (container *html.TagSvg) { return nil }

func (e *StatementLoopDuration) SetFatherId(_ string) {}

func (e *StatementLoopDuration) SetName(name string) {
	e.name = rulesSequentialId.GetIdFromBase(name)
}

func (e *StatementLoopDuration) GetID() string   { return e.id }
func (e *StatementLoopDuration) GetName() string { return e.name }

func (e *StatementLoopDuration) SetPosition(x, y rulesDensity.Density) {
	if e.elem != nil {
		e.elem.SetPositionD(x, y)
	}
}

func (e *StatementLoopDuration) SetSize(w, h rulesDensity.Density) {
	e.width = w
	e.height = h
	if e.elem != nil {
		e.elem.SetSizeD(w, h)
...
func (e *StatementLoopDuration) GetWidth() rulesDensity.Density {
	if e.elem != nil {
...
func (e *StatementLoopDuration) GetHeight() rulesDensity.Density {
	if e.elem != nil {
...
func (e *StatementLoopDuration) GetX() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetXD()
	}
	return 0
...
func (e *StatementLoopDuration) GetY() rulesDensity.Density {
	if e.elem != nil {
		return e.elem.GetYD()
	}
	return 0
...
func (e *StatementLoopDuration) SetX(x rulesDensity.Density) {
	if e.elem != nil {
		y := e.elem.GetYD()
...
func (e *StatementLoopDuration) SetY(y rulesDensity.Density) {
	if e.elem != nil {
		x := e.elem.GetXD()
		newX, newY := e.gridAdjust.AdjustCenterD(x, y)
		e.elem.SetPositionD(newX, newY)
...
func (e *StatementLoopDuration) SetWidth(width rulesDensity.Density) {
	e.width = width
	if e.elem != nil {
		h := e.elem.GetHeightD()
...
func (e *StatementLoopDuration) SetHeight(height rulesDensity.Density) {
	e.height = height
	if e.elem != nil {
		w := e.elem.GetWidthD()
...
func (e *StatementLoopDuration) SetSelected(selected bool) {
	if e.selectLocked {
		e.selected = false
		return
	}
...
func (e *StatementLoopDuration) SetDragEnable(enabled bool) {
	if e.dragLocked {
		e.dragEnabled = false
		return
	}
...
func (e *StatementLoopDuration) GetResizeEnable() bool {
	if e.elem != nil {
...
func (e *StatementLoopDuration) SetResizeEnable(enabled bool) {
	if e.resizeLocked {
		return
	}
	if e.elem == nil {
...
func (e *StatementLoopDuration) GetInitialized() bool { return e.initialized }
func (e *StatementLoopDuration) GetDragBlocked() bool { return e.dragLocked }
func (e *StatementLoopDuration) GetDragEnable() bool  { return e.dragEnabled }
func (e *StatementLoopDuration) GetResize() bool {
	if e.elem != nil {
		return e.elem.IsResizeEnabled()
	}
	return false
}
func (e *StatementLoopDuration) GetResizeBlocked() bool { return e.resizeLocked }
func (e *StatementLoopDuration) GetSelectBlocked() bool { return e.selectLocked }
func (e *StatementLoopDuration) GetSelected() bool      { return e.selected }
func (e *StatementLoopDuration) GetZIndex() int {
	if e.elem != nil {
...
func (e *StatementLoopDuration) onConnectionClick() {}
...
func (e *StatementLoopDuration) Init() error {
	if e.stage == nil {
	...
	e.ornamentDraw = new(doubleLoopArrowHourglass.DoubleLoopArrowHourglass)
	e.ornamentDrawIcon = new(doubleLoopArrowHourglass.DoubleLoopArrowHourglass)

	intervalButton := connection.Setup{
		FatherId:           e.id,
		Name:               "intervalButton",
	...
	if err := intervalButton.Verify(); err != nil {
		log.Printf("intervalButton.Verify: %v", err)
		return err
	}

	e.ornamentDraw.IntervalButtonSetup(intervalButton)
...
func (e *StatementLoopDuration) getBodyMenuItems() []contextMenu.Item {
	...
	return []contextMenu.Item{
		mainMenu.DeleteItem(func() {
			log.Printf("[LoopDuration] delete: %v", e.id)
			e.Remove()
		}),
...
func (e *StatementLoopDuration) showChildBoundsOverlay(bounds rulesContainer.Rect) {
...
func (e *StatementLoopDuration) hideChildBoundsOverlay() {
...
func (e *StatementLoopDuration) wireEvents() {
	// -----------------------------------------------------------------
		...
		if rulesConnection.PinHit(rulesConnection.PinSideLeft,
			...
			if e.ctxMenu != nil && e.wireMgr != nil {
				...
				go e.ctxMenu.OpenAtWorld(
					mainMenu.ConnectorMenu(e.wireMgr, e.id, "interval"),
					menuX, menuY,
				)
			}
			return
	...
	e.elem.SetOnDragEnd(func(event sprite.DragEvent) {
		...
		// The LoopDuration's own interval-port wire needs re-routing after the move.
		if e.wireMgr != nil {
			e.wireMgr.RecalculateForElement(e.id)
		}
...
func (e *StatementLoopDuration) recacheOrnament() {
...
func (e *StatementLoopDuration) GetIconName() string     { return "LoopDuration" }
func (e *StatementLoopDuration) GetIconCategory() string { return "Loop" }
func (e *StatementLoopDuration) SetStatus(status int)    { e.iconStatus = status }
func (e *StatementLoopDuration) GetStatus() int          { return e.iconStatus }

func (e *StatementLoopDuration) getIcon(data rulesIcon.Data) js.Value {
...
func (e *StatementLoopDuration) RegisterConnectors() {
	if e.wireMgr == nil || e.elem == nil {
		return
	}
	e.wireMgr.RegisterConnector(wire.ConnectorInfo{
		ID:                 wire.ConnectorID{ElementID: e.id, PortName: "interval"},
		IsOutput:           false,
		...
		PositionFunc: func() (float64, float64) {
			...
			w, h := e.elem.GetSize()
			// Interval button position matches DoubleLoopArrow.Update().
	...
	// matching StatementLoop and StatementCase. The closure returns the current
	// geometry so the marker tracks drags and resizes; a nil element yields a
	// zero rect, which the renderer skips. The DoubleLoopArrowHourglass border is
	// drawn inset by margin = Density(10) — the same inset caseBorder and the
	// plain loop use — so the tunnel sits on that visible border line, not on the
	// outer (mathematical) bounding box. Frontend-only: the tunnel is an overlay
	// on an existing wire and changes nothing in codegen, the serializer, or
	// persistence.
	//
	...
	// StatementLoop e ao StatementCase. O closure devolve a geometria atual para
	// o marcador acompanhar arrasto e resize; elemento nil dá rect zero, que o
	// renderer ignora. A borda DoubleLoopArrowHourglass usa inset margin =
	// Density(10) (o mesmo do caseBorder e do loop comum), então o túnel senta
	// nessa linha visível, não na bbox externa. É só frontend.
...
func (e *StatementLoopDuration) showInspectOverlay() { overlay.Show(e.inspectConfig()) }

func (e *StatementLoopDuration) inspectConfig() overlay.Config {
...
func (e *StatementLoopDuration) ApplyProperties(values map[string]string) {
...
func (e *StatementLoopDuration) GetProperties() map[string]interface{} {
...
func (e *StatementLoopDuration) GetComment() string { return e.comment }
