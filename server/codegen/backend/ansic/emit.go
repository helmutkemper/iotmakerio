...
func Emit(prog *ir.Program, profile TargetProfile) map[string]string {
	...
	// Stamp the Generated Code Exception header on every emitted file so a
	...
	// removes no keys.
	//
	// Português: Carimba o header da exceção em cada arquivo emitido, pra um
	// scanner de licença saber, lendo qualquer arquivo gerado, que ele está
	// liberado do copyleft AGPL (fonte: GENERATED-CODE-EXCEPTION.md). Atualizar
