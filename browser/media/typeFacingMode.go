// browser/media/typeFacingMode.go
//
...
func (e FacingMode) String() string {
	return string(e)
}
...
const (
	...
	KFacingModeUser FacingMode = "user"
	...
	// smartphone.
	KFacingModeEnvironment FacingMode = "environment"
	...
	// ombro esquerdo.
	KFacingModeLeft FacingMode = "left"
	...
	// ombro direito.
	KFacingModeRight FacingMode = "right"
)
