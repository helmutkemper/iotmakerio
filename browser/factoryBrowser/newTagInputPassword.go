// browser/factoryBrowser/newTagInputPassword.go
//
...
func NewTagInputPassword() (ref *html.TagInputPassword) {
	ref = &html.TagInputPassword{}
	ref.CreateElement(html.KTagInput)
	ref.Type(html.KInputTypePassword)
