// browser/html/typeTagSvgStop.go
//
...
func (e *TagSvgStop) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgStop) CreateElement() (ref *TagSvgStop) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "stop")
...
func (e *TagSvgStop) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgStop) Tabindex(value interface{}) (ref *TagSvgStop) {
...
func (e *TagSvgStop) Cursor(value interface{}) (ref *TagSvgStop) {
...
//	    mais informações.
func (e *TagSvgStop) Direction(value interface{}) (ref *TagSvgStop) {
...
func (e *TagSvgStop) DominantBaseline(value interface{}) (ref *TagSvgStop) {
...
func (e *TagSvgStop) FillRule(value interface{}) (ref *TagSvgStop) {
...
func (e *TagSvgStop) FontStyle(value interface{}) (ref *TagSvgStop) {
...
func (e *TagSvgStop) Reference(reference **TagSvgStop) (ref *TagSvgStop) {
	*reference = e
	return e
}
...
func (e *TagSvgStop) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgStop) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgStop) ListenerRemove(event string) (ref *TagSvgStop) {
...
func (e *TagSvgStop) Remove(elements ...Compatible) (ref *TagSvgStop) {
	for _, element := range elements {
