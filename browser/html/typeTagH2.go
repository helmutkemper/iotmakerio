...
func (e *TagH2) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagH2) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagH2) ListenerRemove(event string) (ref *TagH2) {
...
func (e *TagH2) SetAttribute(key string, value any) (ref *TagH2) {
...
func (e *TagH2) GetAttribute(key string) (value string) {
...
func (e *TagH2) RemoveAttribute(key string) (value string) {
...
func (e *TagH2) Remove(elements ...Compatible) (ref *TagH2) {
	for _, element := range elements {
...
func (e *TagH2) SetZIndex(index int) (ref *TagH2) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH2) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH2) RemoveZIndex() (ref *TagH2) {
