...
func (e *TagImg) SetAttribute(key string, value any) (ref *TagImg) {
...
func (e *TagImg) GetAttribute(key string) (value string) {
...
func (e *TagImg) RemoveAttribute(key string) (value string) {
...
func (e *TagImg) Remove(elements ...Compatible) (ref *TagImg) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagImg) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagImg) RemoveZIndex() (ref *TagImg) {
