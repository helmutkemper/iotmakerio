// browser/html/typeTagInputDateTimeLocal.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputDateTimeLocal) GetId() (id string) {
	return e.id
}
...
func (e *TagInputDateTimeLocal) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputDateTimeLocal) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputDateTimeLocal) ListenerRemove(event string) (ref *TagInputDateTimeLocal) {
...
func (e *TagInputDateTimeLocal) SetAttribute(key string, value any) (ref *TagInputDateTimeLocal) {
...
func (e *TagInputDateTimeLocal) GetAttribute(key string) (value string) {
...
func (e *TagInputDateTimeLocal) RemoveAttribute(key string) (value string) {
...
func (e *TagInputDateTimeLocal) Remove(elements ...Compatible) (ref *TagInputDateTimeLocal) {
...
func (e *TagInputDateTimeLocal) SetZIndex(index int) (ref *TagInputDateTimeLocal) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputDateTimeLocal) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputDateTimeLocal) RemoveZIndex() (ref *TagInputDateTimeLocal) {
