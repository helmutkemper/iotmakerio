// browser/html/typeTagSvgSymbol.go
//
...
func (e *TagSvgSymbol) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgSymbol) CreateElement() (ref *TagSvgSymbol) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "symbol")
...
func (e *TagSvgSymbol) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgSymbol) Tabindex(value interface{}) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) Cursor(value interface{}) (ref *TagSvgSymbol) {
...
//	    mais informações.
func (e *TagSvgSymbol) Direction(value interface{}) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) DominantBaseline(value interface{}) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) FillRule(value interface{}) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) FontStyle(value interface{}) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) GetXY() (x, y int) {
	x = e.x
	y = e.y
	return
}
...
func (e *TagSvgSymbol) GetX() (x int) {
	return e.x
}
...
func (e *TagSvgSymbol) GetY() (y int) {
	return e.y
}
...
func (e *TagSvgSymbol) GetTop() (top float64) {
...
func (e *TagSvgSymbol) GetRight() (right float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgSymbol) GetBottom() (bottom float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgSymbol) GetLeft() (left float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgSymbol) Reference(reference **TagSvgSymbol) (ref *TagSvgSymbol) {
	*reference = e
	return e
}
...
func (e *TagSvgSymbol) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagSvgSymbol) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagSvgSymbol) UpdateBoundingClientRect() (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgSymbol) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgSymbol) ListenerRemove(event string) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) SetAttribute(key string, value any) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) GetAttribute(key string) (value string) {
...
func (e *TagSvgSymbol) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgSymbol) Remove(elements ...Compatible) (ref *TagSvgSymbol) {
	for _, element := range elements {
...
func (e *TagSvgSymbol) SetZIndex(index int) (ref *TagSvgSymbol) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgSymbol) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgSymbol) RemoveZIndex() (ref *TagSvgSymbol) {
