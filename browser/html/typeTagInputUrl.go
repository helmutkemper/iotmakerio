// browser/html/typeTagInputUrl.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputUrl) GetId() (id string) {
	return e.id
}
...
func (e *TagInputUrl) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputUrl) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputUrl) ListenerRemove(event string) (ref *TagInputUrl) {
...
func (e *TagInputUrl) SetAttribute(key string, value any) (ref *TagInputUrl) {
...
func (e *TagInputUrl) GetAttribute(key string) (value string) {
...
func (e *TagInputUrl) RemoveAttribute(key string) (value string) {
...
func (e *TagInputUrl) Remove(elements ...Compatible) (ref *TagInputUrl) {
...
func (e *TagInputUrl) SetZIndex(index int) (ref *TagInputUrl) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputUrl) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputUrl) RemoveZIndex() (ref *TagInputUrl) {
