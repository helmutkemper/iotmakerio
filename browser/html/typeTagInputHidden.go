// browser/html/typeTagInputHidden.go
//
...
func (e *TagInputHidden) Reference(reference **TagInputHidden) (ref *TagInputHidden) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputHidden) GetId() (id string) {
	return e.id
}
...
func (e *TagInputHidden) ItemProp(itemprop string) (ref *TagInputHidden) {
...
func (e *TagInputHidden) Part(part ...string) (ref *TagInputHidden) {
...
func (e *TagInputHidden) Nonce(nonce string) (ref *TagInputHidden) {
...
func (e *TagInputHidden) Append(append interface{}) (ref *TagInputHidden) {
	switch append.(type) {
	case *TagInputHidden:
		e.selfElement.Call("appendChild", append.(*TagInputHidden).selfElement)
	case js.Value:
...
func (e *TagInputHidden) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputHidden) GetRight() (right int) {
...
func (e *TagInputHidden) GetBottom() (bottom int) {
...
func (e *TagInputHidden) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputHidden) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputHidden) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputHidden) UpdateBoundingClientRect() (ref *TagInputHidden) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputHidden) SetDeltaX(delta int) (ref *TagInputHidden) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputHidden) SetDeltaY(delta int) (ref *TagInputHidden) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputHidden) Get() (el js.Value) {
...
func (e *TagInputHidden) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputHidden) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputHidden) ListenerRemove(event string) (ref *TagInputHidden) {
...
func (e *TagInputHidden) SetAttribute(key string, value any) (ref *TagInputHidden) {
...
func (e *TagInputHidden) GetAttribute(key string) (value string) {
...
func (e *TagInputHidden) RemoveAttribute(key string) (value string) {
...
func (e *TagInputHidden) Remove(elements ...Compatible) (ref *TagInputHidden) {
...
func (e *TagInputHidden) SetZIndex(index int) (ref *TagInputHidden) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputHidden) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputHidden) RemoveZIndex() (ref *TagInputHidden) {
