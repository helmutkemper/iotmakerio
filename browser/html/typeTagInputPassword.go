// browser/html/typeTagInputPassword.go
//
...
func (e *TagInputPassword) Reference(reference **TagInputPassword) (ref *TagInputPassword) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputPassword) GetId() (id string) {
	return e.id
}
...
func (e *TagInputPassword) ItemProp(itemprop string) (ref *TagInputPassword) {
...
func (e *TagInputPassword) Part(part ...string) (ref *TagInputPassword) {
...
func (e *TagInputPassword) Nonce(nonce string) (ref *TagInputPassword) {
...
func (e *TagInputPassword) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputPassword) GetRight() (right int) {
...
func (e *TagInputPassword) GetBottom() (bottom int) {
...
func (e *TagInputPassword) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputPassword) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputPassword) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputPassword) UpdateBoundingClientRect() (ref *TagInputPassword) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputPassword) SetDeltaX(delta int) (ref *TagInputPassword) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputPassword) SetDeltaY(delta int) (ref *TagInputPassword) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputPassword) Get() (el js.Value) {
...
func (e *TagInputPassword) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputPassword) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputPassword) ListenerRemove(event string) (ref *TagInputPassword) {
...
func (e *TagInputPassword) SetAttribute(key string, value any) (ref *TagInputPassword) {
...
func (e *TagInputPassword) GetAttribute(key string) (value string) {
...
func (e *TagInputPassword) RemoveAttribute(key string) (value string) {
...
func (e *TagInputPassword) Remove(elements ...Compatible) (ref *TagInputPassword) {
...
func (e *TagInputPassword) SetZIndex(index int) (ref *TagInputPassword) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputPassword) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputPassword) RemoveZIndex() (ref *TagInputPassword) {
