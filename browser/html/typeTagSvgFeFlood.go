// browser/html/typeTagSvgFeFlood.go
//
...
func (e *TagSvgFeFlood) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeFlood) CreateElement() (ref *TagSvgFeFlood) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feFlood")
...
func (e *TagSvgFeFlood) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgFeFlood) Cursor(value interface{}) (ref *TagSvgFeFlood) {
...
//	    mais informações.
func (e *TagSvgFeFlood) Direction(value interface{}) (ref *TagSvgFeFlood) {
...
func (e *TagSvgFeFlood) DominantBaseline(value interface{}) (ref *TagSvgFeFlood) {
...
func (e *TagSvgFeFlood) FillRule(value interface{}) (ref *TagSvgFeFlood) {
...
func (e *TagSvgFeFlood) FontStyle(value interface{}) (ref *TagSvgFeFlood) {
...
func (e *TagSvgFeFlood) Reference(reference **TagSvgFeFlood) (ref *TagSvgFeFlood) {
	*reference = e
	return e
}
...
func (e *TagSvgFeFlood) Remove(elements ...Compatible) (ref *TagSvgFeFlood) {
	for _, element := range elements {
