// browser/html/typeTagTextArea.go
//
...
func (e *TagTextArea) Reference(reference **TagTextArea) (ref *TagTextArea) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagTextArea) GetId() (id string) {
	return e.id
}
...
func (e *TagTextArea) ItemProp(itemprop string) (ref *TagTextArea) {
...
func (e *TagTextArea) Part(part ...string) (ref *TagTextArea) {
...
func (e *TagTextArea) Nonce(nonce string) (ref *TagTextArea) {
...
func (e *TagTextArea) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagTextArea) GetRight() (right int) {
...
func (e *TagTextArea) GetBottom() (bottom int) {
...
func (e *TagTextArea) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagTextArea) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagTextArea) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagTextArea) UpdateBoundingClientRect() (ref *TagTextArea) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagTextArea) SetDeltaX(delta int) (ref *TagTextArea) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagTextArea) SetDeltaY(delta int) (ref *TagTextArea) {
	e.deltaMovieY = delta
	return e
}
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagTextArea) ListenerRemove(event string) (ref *TagTextArea) {
...
func (e *TagTextArea) SetAttribute(key string, value any) (ref *TagTextArea) {
...
func (e *TagTextArea) GetAttribute(key string) (value string) {
...
func (e *TagTextArea) RemoveAttribute(key string) (value string) {
...
func (e *TagTextArea) Remove(elements ...Compatible) (ref *TagTextArea) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagTextArea) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagTextArea) RemoveZIndex() (ref *TagTextArea) {
