// browser/html/typeTagSvgFeOffset.go
//
...
func (e *TagSvgFeOffset) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeOffset) CreateElement() (ref *TagSvgFeOffset) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feOffset")
...
func (e *TagSvgFeOffset) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeOffset) Tabindex(value interface{}) (ref *TagSvgFeOffset) {
...
func (e *TagSvgFeOffset) Cursor(value interface{}) (ref *TagSvgFeOffset) {
...
//	    mais informações.
func (e *TagSvgFeOffset) Direction(value interface{}) (ref *TagSvgFeOffset) {
...
func (e *TagSvgFeOffset) DominantBaseline(value interface{}) (ref *TagSvgFeOffset) {
...
func (e *TagSvgFeOffset) FillRule(value interface{}) (ref *TagSvgFeOffset) {
...
func (e *TagSvgFeOffset) FontStyle(value interface{}) (ref *TagSvgFeOffset) {
