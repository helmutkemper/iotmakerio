...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagLegend) GetId() (id string) {
	return e.id
}
...
func (e *TagLegend) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagLegend) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagLegend) ListenerRemove(event string) (ref *TagLegend) {
...
func (e *TagLegend) SetAttribute(key string, value any) (ref *TagLegend) {
...
func (e *TagLegend) GetAttribute(key string) (value string) {
...
func (e *TagLegend) RemoveAttribute(key string) (value string) {
...
func (e *TagLegend) Remove(elements ...Compatible) (ref *TagLegend) {
...
func (e *TagLegend) SetZIndex(index int) (ref *TagLegend) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagLegend) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagLegend) RemoveZIndex() (ref *TagLegend) {
