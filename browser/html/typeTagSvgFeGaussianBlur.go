// browser/html/typeTagSvgFeGaussianBlur.go
//
...
func (e *TagSvgFeGaussianBlur) prepareStageReference() {
...
func (e *TagSvgFeGaussianBlur) Id(id string) (ref *TagSvgFeGaussianBlur) {
	e.id = id
...
func (e *TagSvgFeGaussianBlur) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeGaussianBlur) Tabindex(value interface{}) (ref *TagSvgFeGaussianBlur) {
...
func (e *TagSvgFeGaussianBlur) Cursor(value interface{}) (ref *TagSvgFeGaussianBlur) {
...
//	    mais informações.
func (e *TagSvgFeGaussianBlur) Direction(value interface{}) (ref *TagSvgFeGaussianBlur) {
...
func (e *TagSvgFeGaussianBlur) DominantBaseline(value interface{}) (ref *TagSvgFeGaussianBlur) {
...
func (e *TagSvgFeGaussianBlur) FillRule(value interface{}) (ref *TagSvgFeGaussianBlur) {
...
func (e *TagSvgFeGaussianBlur) FontStyle(value interface{}) (ref *TagSvgFeGaussianBlur) {
...
func (e *TagSvgFeGaussianBlur) Reference(reference **TagSvgFeGaussianBlur) (ref *TagSvgFeGaussianBlur) {
	*reference = e
	return e
}
