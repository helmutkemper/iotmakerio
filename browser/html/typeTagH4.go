...
func (e *TagH4) Reference(reference **TagH4) (ref *TagH4) {
	*reference = e
	return e
}
...
func (e *TagH4) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagH4) UpdateBoundingClientRect() (ref *TagH4) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagH4) ListenerRemove(event string) (ref *TagH4) {
...
func (e *TagH4) SetAttribute(key string, value any) (ref *TagH4) {
...
func (e *TagH4) GetAttribute(key string) (value string) {
...
func (e *TagH4) RemoveAttribute(key string) (value string) {
...
func (e *TagH4) Remove(elements ...Compatible) (ref *TagH4) {
	for _, element := range elements {
...
func (e *TagH4) SetZIndex(index int) (ref *TagH4) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH4) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH4) RemoveZIndex() (ref *TagH4) {
