...
func (e *TagH5) Reference(reference **TagH5) (ref *TagH5) {
	*reference = e
	return e
}
...
func (e *TagH5) ItemProp(itemprop string) (ref *TagH5) {
...
func (e *TagH5) Part(part ...string) (ref *TagH5) {
...
func (e *TagH5) Nonce(nonce string) (ref *TagH5) {
...
func (e *TagH5) CreateElement() (ref *TagH5) {
	e.selfElement = js.Global().Get("document").Call("createElement", "h5")
...
func (e *TagH5) prepareStageReference() {
...
func (e *TagH5) onStopDragNormal(_ js.Value, _ []js.Value) interface{} {
	e.isDragging = false
	return nil
}

func (e *TagH5) onStartDragNormal(event mouse.Event) {
...
func (e *TagH5) onMouseDraggingNormal(_ js.Value, args []js.Value) interface{} {
...
func (e *TagH5) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagH5) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagH5) UpdateBoundingClientRect() (ref *TagH5) {
...
func (e *TagH5) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagH5) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagH5) ListenerRemove(event string) (ref *TagH5) {
...
func (e *TagH5) SetAttribute(key string, value any) (ref *TagH5) {
...
func (e *TagH5) GetAttribute(key string) (value string) {
...
func (e *TagH5) RemoveAttribute(key string) (value string) {
...
func (e *TagH5) Remove(elements ...Compatible) (ref *TagH5) {
	for _, element := range elements {
...
func (e *TagH5) SetZIndex(index int) (ref *TagH5) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH5) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH5) RemoveZIndex() (ref *TagH5) {
