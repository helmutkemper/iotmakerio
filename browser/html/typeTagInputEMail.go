// browser/html/typeTagInputEMail.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputMail) GetId() (id string) {
	return e.id
}
...
func (e *TagInputMail) SetAttribute(key string, value any) (ref *TagInputMail) {
...
func (e *TagInputMail) GetAttribute(key string) (value string) {
...
func (e *TagInputMail) RemoveAttribute(key string) (value string) {
...
func (e *TagInputMail) Remove(elements ...Compatible) (ref *TagInputMail) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputMail) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputMail) RemoveZIndex() (ref *TagInputMail) {
