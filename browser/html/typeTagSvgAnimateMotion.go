// browser/html/typeTagSvgAnimateMotion.go
//
...
func (e *TagSvgAnimateMotion) GetId() (id string) {
	return e.id
}
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgAnimateMotion) ListenerRemove(event string) (ref *TagSvgAnimateMotion) {
...
func (e *TagSvgAnimateMotion) SetAttribute(key string, value any) (ref *TagSvgAnimateMotion) {
...
func (e *TagSvgAnimateMotion) GetAttribute(key string) (value string) {
...
func (e *TagSvgAnimateMotion) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgAnimateMotion) Remove(elements ...Compatible) (ref *TagSvgAnimateMotion) {
	for _, element := range elements {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgAnimateMotion) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgAnimateMotion) RemoveZIndex() (ref *TagSvgAnimateMotion) {
