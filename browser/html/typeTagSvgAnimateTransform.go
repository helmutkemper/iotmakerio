// browser/html/typeTagSvgAnimateTransform.go
//
...
import (
	...
	"github.com/helmutkemper/iotmakerio/browser/event/animation"
	"github.com/helmutkemper/iotmakerio/platform/engine"
)
...
func (e *TagSvgAnimateTransform) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgAnimateTransform) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgAnimateTransform) ListenerRemove(event string) (ref *TagSvgAnimateTransform) {
...
func (e *TagSvgAnimateTransform) SetAttribute(key string, value any) (ref *TagSvgAnimateTransform) {
...
func (e *TagSvgAnimateTransform) GetAttribute(key string) (value string) {
...
func (e *TagSvgAnimateTransform) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgAnimateTransform) SetZIndex(index int) (ref *TagSvgAnimateTransform) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgAnimateTransform) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgAnimateTransform) RemoveZIndex() (ref *TagSvgAnimateTransform) {
