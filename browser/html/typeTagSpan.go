...
func (e *TagSpan) SetAttribute(key string, value any) (ref *TagSpan) {
...
func (e *TagSpan) GetAttribute(key string) (value string) {
...
func (e *TagSpan) RemoveAttribute(key string) (value string) {
...
func (e *TagSpan) Remove(elements ...Compatible) (ref *TagSpan) {
	for _, element := range elements {
...
func (e *TagSpan) SetZIndex(index int) (ref *TagSpan) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSpan) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSpan) RemoveZIndex() (ref *TagSpan) {
