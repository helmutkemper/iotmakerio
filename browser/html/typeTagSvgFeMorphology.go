// browser/html/typeTagSvgFeMorphology.go
//
...
func (e *TagSvgFeMorphology) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeMorphology) CreateElement() (ref *TagSvgFeMorphology) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feMorphology")
...
func (e *TagSvgFeMorphology) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeMorphology) Tabindex(value interface{}) (ref *TagSvgFeMorphology) {
...
func (e *TagSvgFeMorphology) Cursor(value interface{}) (ref *TagSvgFeMorphology) {
...
//	    mais informações.
func (e *TagSvgFeMorphology) Direction(value interface{}) (ref *TagSvgFeMorphology) {
...
func (e *TagSvgFeMorphology) DominantBaseline(value interface{}) (ref *TagSvgFeMorphology) {
...
func (e *TagSvgFeMorphology) FillRule(value interface{}) (ref *TagSvgFeMorphology) {
...
func (e *TagSvgFeMorphology) FontStyle(value interface{}) (ref *TagSvgFeMorphology) {
...
func (e *TagSvgFeMorphology) Reference(reference **TagSvgFeMorphology) (ref *TagSvgFeMorphology) {
	*reference = e
	return e
}
