// browser/html/typeTagSvgFeConvolveMatrix.go
//
...
func (e *TagSvgFeConvolveMatrix) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgFeConvolveMatrix) Cursor(value interface{}) (ref *TagSvgFeConvolveMatrix) {
...
//	    mais informações.
func (e *TagSvgFeConvolveMatrix) Direction(value interface{}) (ref *TagSvgFeConvolveMatrix) {
...
func (e *TagSvgFeConvolveMatrix) DominantBaseline(value interface{}) (ref *TagSvgFeConvolveMatrix) {
...
func (e *TagSvgFeConvolveMatrix) FillRule(value interface{}) (ref *TagSvgFeConvolveMatrix) {
