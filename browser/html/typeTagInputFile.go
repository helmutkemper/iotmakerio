// browser/html/typeTagInputFile.go
//
...
func (e *TagInputFile) Reference(reference **TagInputFile) (ref *TagInputFile) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputFile) GetId() (id string) {
	return e.id
}
...
func (e *TagInputFile) ItemProp(itemprop string) (ref *TagInputFile) {
...
func (e *TagInputFile) Part(part ...string) (ref *TagInputFile) {
...
func (e *TagInputFile) Nonce(nonce string) (ref *TagInputFile) {
...
func (e *TagInputFile) Append(append interface{}) (ref *TagInputFile) {
	switch append.(type) {
	case *TagInputFile:
		e.selfElement.Call("appendChild", append.(*TagInputFile).selfElement)
	case js.Value:
...
func (e *TagInputFile) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputFile) GetRight() (right int) {
...
func (e *TagInputFile) GetBottom() (bottom int) {
...
func (e *TagInputFile) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputFile) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputFile) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputFile) UpdateBoundingClientRect() (ref *TagInputFile) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputFile) SetDeltaX(delta int) (ref *TagInputFile) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputFile) SetDeltaY(delta int) (ref *TagInputFile) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputFile) Get() (el js.Value) {
...
func (e *TagInputFile) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputFile) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputFile) ListenerRemove(event string) (ref *TagInputFile) {
...
func (e *TagInputFile) SetAttribute(key string, value any) (ref *TagInputFile) {
...
func (e *TagInputFile) GetAttribute(key string) (value string) {
...
func (e *TagInputFile) RemoveAttribute(key string) (value string) {
...
func (e *TagInputFile) Remove(elements ...Compatible) (ref *TagInputFile) {
...
func (e *TagInputFile) SetZIndex(index int) (ref *TagInputFile) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputFile) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputFile) RemoveZIndex() (ref *TagInputFile) {
