...
func (e *TagOutput) Reference(reference **TagOutput) (ref *TagOutput) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagOutput) GetId() (id string) {
	return e.id
}
...
func (e *TagOutput) ItemProp(itemprop string) (ref *TagOutput) {
...
func (e *TagOutput) Part(part ...string) (ref *TagOutput) {
...
func (e *TagOutput) Nonce(nonce string) (ref *TagOutput) {
...
func (e *TagOutput) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagOutput) GetRight() (right int) {
...
func (e *TagOutput) GetBottom() (bottom int) {
...
func (e *TagOutput) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagOutput) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagOutput) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagOutput) UpdateBoundingClientRect() (ref *TagOutput) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagOutput) SetDeltaX(delta int) (ref *TagOutput) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagOutput) SetDeltaY(delta int) (ref *TagOutput) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagOutput) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagOutput) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagOutput) ListenerRemove(event string) (ref *TagOutput) {
...
func (e *TagOutput) SetAttribute(key string, value any) (ref *TagOutput) {
...
func (e *TagOutput) GetAttribute(key string) (value string) {
...
func (e *TagOutput) RemoveAttribute(key string) (value string) {
...
func (e *TagOutput) Remove(elements ...Compatible) (ref *TagOutput) {
...
func (e *TagOutput) SetZIndex(index int) (ref *TagOutput) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagOutput) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagOutput) RemoveZIndex() (ref *TagOutput) {
