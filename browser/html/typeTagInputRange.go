// browser/html/typeTagInputRange.go
//
...
func (e *TagInputRange) AddStyle(key string, value any) (ref *TagInputRange) {
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputRange) GetId() (id string) {
	return e.id
}
...
func (e *TagInputRange) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputRange) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputRange) ListenerRemove(event string) (ref *TagInputRange) {
...
func (e *TagInputRange) SetAttribute(key string, value any) (ref *TagInputRange) {
...
func (e *TagInputRange) GetAttribute(key string) (value string) {
...
func (e *TagInputRange) RemoveAttribute(key string) (value string) {
...
func (e *TagInputRange) Remove(elements ...Compatible) (ref *TagInputRange) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputRange) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputRange) RemoveZIndex() (ref *TagInputRange) {
