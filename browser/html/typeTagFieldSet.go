// browser/html/typeTagFieldSet.go
//
...
func (e *TagFieldset) Reference(reference **TagFieldset) (ref *TagFieldset) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagFieldset) GetId() (id string) {
	return e.id
}
...
func (e *TagFieldset) ItemProp(itemprop string) (ref *TagFieldset) {
...
func (e *TagFieldset) Part(part ...string) (ref *TagFieldset) {
...
func (e *TagFieldset) Nonce(nonce string) (ref *TagFieldset) {
...
func (e *TagFieldset) Append(append interface{}) (ref *TagFieldset) {
	switch append.(type) {
	case *TagFieldset:
		e.selfElement.Call("appendChild", append.(*TagFieldset).selfElement)
	case js.Value:
...
func (e *TagFieldset) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagFieldset) GetRight() (right int) {
...
func (e *TagFieldset) GetBottom() (bottom int) {
...
func (e *TagFieldset) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagFieldset) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagFieldset) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagFieldset) UpdateBoundingClientRect() (ref *TagFieldset) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagFieldset) SetDeltaX(delta int) (ref *TagFieldset) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagFieldset) SetDeltaY(delta int) (ref *TagFieldset) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagFieldset) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagFieldset) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagFieldset) ListenerRemove(event string) (ref *TagFieldset) {
...
func (e *TagFieldset) SetAttribute(key string, value any) (ref *TagFieldset) {
...
func (e *TagFieldset) GetAttribute(key string) (value string) {
...
func (e *TagFieldset) RemoveAttribute(key string) (value string) {
...
func (e *TagFieldset) SetZIndex(index int) (ref *TagFieldset) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagFieldset) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagFieldset) RemoveZIndex() (ref *TagFieldset) {
