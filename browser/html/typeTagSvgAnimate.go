// browser/html/typeTagSvgAnimate.go
//
...
func (e *TagSvgAnimate) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgAnimate) SetAttribute(key string, value any) (ref *TagSvgAnimate) {
...
func (e *TagSvgAnimate) GetAttribute(key string) (value string) {
...
func (e *TagSvgAnimate) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgAnimate) Remove(elements ...Compatible) (ref *TagSvgAnimate) {
	for _, element := range elements {
...
func (e *TagSvgAnimate) SetZIndex(index int) (ref *TagSvgAnimate) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgAnimate) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgAnimate) RemoveZIndex() (ref *TagSvgAnimate) {
