...
func (e *TagSvgG) SetAttribute(key string, value any) (ref *TagSvgG) {
...
func (e *TagSvgG) GetAttribute(key string) (value string) {
...
func (e *TagSvgG) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgG) Remove(elements ...Compatible) (ref *TagSvgG) {
	for _, element := range elements {
...
func (e *TagSvgG) SetZIndex(index int) (ref *TagSvgG) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgG) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgG) RemoveZIndex() (ref *TagSvgG) {
