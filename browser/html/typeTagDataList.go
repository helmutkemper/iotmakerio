// browser/html/typeTagDataList.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagDataList) GetId() (id string) {
	return e.id
}
...
func (e *TagDataList) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagDataList) GetRight() (right int) {
...
func (e *TagDataList) GetBottom() (bottom int) {
...
func (e *TagDataList) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagDataList) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagDataList) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagDataList) UpdateBoundingClientRect() (ref *TagDataList) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagDataList) SetDeltaX(delta int) (ref *TagDataList) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagDataList) SetDeltaY(delta int) (ref *TagDataList) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagDataList) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagDataList) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagDataList) ListenerRemove(event string) (ref *TagDataList) {
...
func (e *TagDataList) SetAttribute(key string, value any) (ref *TagDataList) {
...
func (e *TagDataList) GetAttribute(key string) (value string) {
...
func (e *TagDataList) RemoveAttribute(key string) (value string) {
...
func (e *TagDataList) Remove(elements ...Compatible) (ref *TagDataList) {
...
func (e *TagDataList) SetZIndex(index int) (ref *TagDataList) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagDataList) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagDataList) RemoveZIndex() (ref *TagDataList) {
