// browser/html/typeTagSvgFeDistantLight.go
//
...
func (e *TagSvgFeDistantLight) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgFeDistantLight) Remove(elements ...Compatible) (ref *TagSvgFeDistantLight) {
	for _, element := range elements {
