...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagButton) GetId() (id string) {
	return e.id
}
...
func (e *TagButton) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagButton) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagButton) ListenerRemove(event string) (ref *TagButton) {
...
func (e *TagButton) SetAttribute(key string, value any) (ref *TagButton) {
...
func (e *TagButton) GetAttribute(key string) (value string) {
...
func (e *TagButton) RemoveAttribute(key string) (value string) {
...
func (e *TagButton) Remove(elements ...Compatible) (ref *TagButton) {
...
func (e *TagButton) SetZIndex(index int) (ref *TagButton) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagButton) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagButton) RemoveZIndex() (ref *TagButton) {
