...
func (e *TagH1) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagH1) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagH1) ListenerRemove(event string) (ref *TagH1) {
...
func (e *TagH1) SetAttribute(key string, value any) (ref *TagH1) {
...
func (e *TagH1) GetAttribute(key string) (value string) {
...
func (e *TagH1) RemoveAttribute(key string) (value string) {
...
func (e *TagH1) Remove(elements ...Compatible) (ref *TagH1) {
	for _, element := range elements {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH1) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagH1) RemoveZIndex() (ref *TagH1) {
