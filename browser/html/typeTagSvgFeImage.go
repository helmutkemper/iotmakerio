// browser/html/typeTagSvgFeImage.go
//
...
func (e *TagSvgFeImage) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeImage) CreateElement() (ref *TagSvgFeImage) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feImage")
...
func (e *TagSvgFeImage) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeImage) Tabindex(value interface{}) (ref *TagSvgFeImage) {
...
func (e *TagSvgFeImage) Cursor(value interface{}) (ref *TagSvgFeImage) {
...
//	    mais informações.
func (e *TagSvgFeImage) Direction(value interface{}) (ref *TagSvgFeImage) {
...
func (e *TagSvgFeImage) DominantBaseline(value interface{}) (ref *TagSvgFeImage) {
...
func (e *TagSvgFeImage) FillRule(value interface{}) (ref *TagSvgFeImage) {
...
func (e *TagSvgFeImage) FontStyle(value interface{}) (ref *TagSvgFeImage) {
...
func (e *TagSvgFeImage) Reference(reference **TagSvgFeImage) (ref *TagSvgFeImage) {
	*reference = e
	return e
}
