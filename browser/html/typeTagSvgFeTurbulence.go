// browser/html/typeTagSvgFeTurbulence.go
//
...
func (e *TagSvgFeTurbulence) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeTurbulence) CreateElement() (ref *TagSvgFeTurbulence) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feTurbulence")
...
func (e *TagSvgFeTurbulence) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeTurbulence) Tabindex(value interface{}) (ref *TagSvgFeTurbulence) {
...
func (e *TagSvgFeTurbulence) Cursor(value interface{}) (ref *TagSvgFeTurbulence) {
...
//	    mais informações.
func (e *TagSvgFeTurbulence) Direction(value interface{}) (ref *TagSvgFeTurbulence) {
...
func (e *TagSvgFeTurbulence) DominantBaseline(value interface{}) (ref *TagSvgFeTurbulence) {
...
func (e *TagSvgFeTurbulence) FillRule(value interface{}) (ref *TagSvgFeTurbulence) {
...
func (e *TagSvgFeTurbulence) FontStyle(value interface{}) (ref *TagSvgFeTurbulence) {
