// browser/html/typeTagSvgTextPath.go
//
...
func (e *TagSvgTextPath) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgTextPath) CreateElement() (ref *TagSvgTextPath) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "textPath")
...
func (e *TagSvgTextPath) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgTextPath) Tabindex(value interface{}) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) Cursor(value interface{}) (ref *TagSvgTextPath) {
...
//	    mais informações.
func (e *TagSvgTextPath) Direction(value interface{}) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) DominantBaseline(value interface{}) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) FillRule(value interface{}) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) FontStyle(value interface{}) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) HRef(href interface{}) (ref *TagSvgTextPath) {
...
//	    string: "M20,50 C20,-50 180,150 180,50 C180-50 20,150 20,50 z"
//	    qualquer outro tipo: interface{}
func (e *TagSvgTextPath) Path(value interface{}) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) GetTop() (top float64) {
...
func (e *TagSvgTextPath) GetRight() (right float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgTextPath) GetBottom() (bottom float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgTextPath) GetLeft() (left float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgTextPath) Reference(reference **TagSvgTextPath) (ref *TagSvgTextPath) {
	*reference = e
	return e
}
...
func (e *TagSvgTextPath) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgTextPath) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgTextPath) ListenerRemove(event string) (ref *TagSvgTextPath) {
