// browser/html/typeTagInputTime.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputTime) GetId() (id string) {
	return e.id
}
...
func (e *TagInputTime) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputTime) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputTime) ListenerRemove(event string) (ref *TagInputTime) {
...
func (e *TagInputTime) SetAttribute(key string, value any) (ref *TagInputTime) {
...
func (e *TagInputTime) GetAttribute(key string) (value string) {
...
func (e *TagInputTime) RemoveAttribute(key string) (value string) {
...
func (e *TagInputTime) SetZIndex(index int) (ref *TagInputTime) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputTime) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputTime) RemoveZIndex() (ref *TagInputTime) {
