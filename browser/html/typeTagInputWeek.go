// browser/html/typeTagInputWeek.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputWeek) GetId() (id string) {
	return e.id
}
...
func (e *TagInputWeek) ItemProp(itemprop string) (ref *TagInputWeek) {
...
func (e *TagInputWeek) Part(part ...string) (ref *TagInputWeek) {
...
func (e *TagInputWeek) Nonce(nonce string) (ref *TagInputWeek) {
...
func (e *TagInputWeek) Max(max any) (ref *TagInputWeek) {
...
func (e *TagInputWeek) Min(min any) (ref *TagInputWeek) {
...
//	    :invalid pseudoclass.
func (e *TagInputWeek) Step(step any) (ref *TagInputWeek) {
...
func (e *TagInputWeek) Value(value any) (ref *TagInputWeek) {
...
func (e *TagInputWeek) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputWeek) GetRight() (right int) {
...
func (e *TagInputWeek) GetBottom() (bottom int) {
...
func (e *TagInputWeek) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputWeek) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputWeek) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputWeek) UpdateBoundingClientRect() (ref *TagInputWeek) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputWeek) SetDeltaX(delta int) (ref *TagInputWeek) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputWeek) SetDeltaY(delta int) (ref *TagInputWeek) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputWeek) Get() (el js.Value) {
...
func (e *TagInputWeek) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputWeek) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputWeek) ListenerRemove(event string) (ref *TagInputWeek) {
...
func (e *TagInputWeek) SetAttribute(key string, value any) (ref *TagInputWeek) {
...
func (e *TagInputWeek) GetAttribute(key string) (value string) {
...
func (e *TagInputWeek) RemoveAttribute(key string) (value string) {
...
func (e *TagInputWeek) Remove(elements ...Compatible) (ref *TagInputWeek) {
...
func (e *TagInputWeek) SetZIndex(index int) (ref *TagInputWeek) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputWeek) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputWeek) RemoveZIndex() (ref *TagInputWeek) {
