// browser/html/typeTagInputNumber.go
//
...
func (e *TagInputNumber) prepareStageReference() {
...
func (e *TagInputNumber) Reference(reference **TagInputNumber) (ref *TagInputNumber) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputNumber) GetId() (id string) {
	return e.id
}
...
func (e *TagInputNumber) ItemProp(itemprop string) (ref *TagInputNumber) {
...
func (e *TagInputNumber) Part(part ...string) (ref *TagInputNumber) {
...
func (e *TagInputNumber) Nonce(nonce string) (ref *TagInputNumber) {
...
func (e *TagInputNumber) Append(append interface{}) (ref *TagInputNumber) {
	switch append.(type) {
	case *TagInputNumber:
		e.selfElement.Call("appendChild", append.(*TagInputNumber).selfElement)
	case js.Value:
...
func (e *TagInputNumber) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputNumber) GetRight() (right int) {
...
func (e *TagInputNumber) GetBottom() (bottom int) {
...
func (e *TagInputNumber) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputNumber) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputNumber) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputNumber) UpdateBoundingClientRect() (ref *TagInputNumber) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputNumber) SetDeltaX(delta int) (ref *TagInputNumber) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputNumber) SetDeltaY(delta int) (ref *TagInputNumber) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputNumber) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputNumber) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputNumber) ListenerRemove(event string) (ref *TagInputNumber) {
...
func (e *TagInputNumber) SetAttribute(key string, value any) (ref *TagInputNumber) {
...
func (e *TagInputNumber) GetAttribute(key string) (value string) {
...
func (e *TagInputNumber) RemoveAttribute(key string) (value string) {
...
func (e *TagInputNumber) Remove(elements ...Compatible) (ref *TagInputNumber) {
...
func (e *TagInputNumber) SetZIndex(index int) (ref *TagInputNumber) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputNumber) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputNumber) RemoveZIndex() (ref *TagInputNumber) {
