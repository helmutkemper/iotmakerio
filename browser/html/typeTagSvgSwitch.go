// browser/html/typeTagSvgSwitch.go
//
...
func (e *TagSvgSwitch) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgSwitch) CreateElement() (ref *TagSvgSwitch) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "switch")
...
func (e *TagSvgSwitch) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgSwitch) Tabindex(value interface{}) (ref *TagSvgSwitch) {
...
func (e *TagSvgSwitch) Cursor(value interface{}) (ref *TagSvgSwitch) {
...
//	    mais informações.
func (e *TagSvgSwitch) Direction(value interface{}) (ref *TagSvgSwitch) {
...
func (e *TagSvgSwitch) DominantBaseline(value interface{}) (ref *TagSvgSwitch) {
...
func (e *TagSvgSwitch) FillRule(value interface{}) (ref *TagSvgSwitch) {
...
func (e *TagSvgSwitch) FontStyle(value interface{}) (ref *TagSvgSwitch) {
...
func (e *TagSvgSwitch) Reference(reference **TagSvgSwitch) (ref *TagSvgSwitch) {
	*reference = e
	return e
}
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgSwitch) ListenerRemove(event string) (ref *TagSvgSwitch) {
