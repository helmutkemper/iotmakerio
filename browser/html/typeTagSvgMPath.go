// browser/html/typeTagSvgMPath.go
//
...
func (e *TagSvgMPath) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgMPath) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgMPath) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgMPath) ListenerRemove(event string) (ref *TagSvgMPath) {
...
func (e *TagSvgMPath) SetAttribute(key string, value any) (ref *TagSvgMPath) {
...
func (e *TagSvgMPath) GetAttribute(key string) (value string) {
...
func (e *TagSvgMPath) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgMPath) Remove(elements ...Compatible) (ref *TagSvgMPath) {
	for _, element := range elements {
...
func (e *TagSvgMPath) SetZIndex(index int) (ref *TagSvgMPath) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgMPath) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgMPath) RemoveZIndex() (ref *TagSvgMPath) {
