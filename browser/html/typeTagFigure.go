...
func (e *TagFigure) Reference(reference **TagFigure) (ref *TagFigure) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagFigure) GetId() (id string) {
	return e.id
}
...
func (e *TagFigure) Part(part ...string) (ref *TagFigure) {
...
func (e *TagFigure) Nonce(nonce string) (ref *TagFigure) {
...
func (e *TagFigure) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagFigure) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagFigure) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagFigure) ListenerRemove(event string) (ref *TagFigure) {
...
func (e *TagFigure) SetAttribute(key string, value any) (ref *TagFigure) {
...
func (e *TagFigure) GetAttribute(key string) (value string) {
...
func (e *TagFigure) RemoveAttribute(key string) (value string) {
...
func (e *TagFigure) SetZIndex(index int) (ref *TagFigure) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagFigure) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagFigure) RemoveZIndex() (ref *TagFigure) {
