// browser/html/typeTagInputText.go
//
...
func (e *TagInputText) Reference(reference **TagInputText) (ref *TagInputText) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputText) GetId() (id string) {
	return e.id
}
...
func (e *TagInputText) ItemProp(itemprop string) (ref *TagInputText) {
...
func (e *TagInputText) Part(part ...string) (ref *TagInputText) {
...
func (e *TagInputText) Nonce(nonce string) (ref *TagInputText) {
...
func (e *TagInputText) Append(append interface{}) (ref *TagInputText) {
	switch append.(type) {
	case *TagInputText:
		e.selfElement.Call("appendChild", append.(*TagInputText).selfElement)
	case js.Value:
...
func (e *TagInputText) Value(value any) (ref *TagInputText) {
...
func (e *TagInputText) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputText) GetRight() (right int) {
...
func (e *TagInputText) GetBottom() (bottom int) {
...
func (e *TagInputText) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputText) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputText) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputText) UpdateBoundingClientRect() (ref *TagInputText) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputText) SetDeltaX(delta int) (ref *TagInputText) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputText) SetDeltaY(delta int) (ref *TagInputText) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputText) Get() (el js.Value) {
...
func (e *TagInputText) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputText) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputText) ListenerRemove(event string) (ref *TagInputText) {
...
func (e *TagInputText) SetAttribute(key string, value any) (ref *TagInputText) {
...
func (e *TagInputText) GetAttribute(key string) (value string) {
...
func (e *TagInputText) RemoveAttribute(key string) (value string) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputText) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputText) RemoveZIndex() (ref *TagInputText) {
