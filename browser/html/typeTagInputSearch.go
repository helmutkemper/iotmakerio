// browser/html/typeTagInputSearch.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputSearch) GetId() (id string) {
	return e.id
}
...
func (e *TagInputSearch) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputSearch) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputSearch) ListenerRemove(event string) (ref *TagInputSearch) {
...
func (e *TagInputSearch) SetAttribute(key string, value any) (ref *TagInputSearch) {
...
func (e *TagInputSearch) GetAttribute(key string) (value string) {
...
func (e *TagInputSearch) RemoveAttribute(key string) (value string) {
...
func (e *TagInputSearch) SetZIndex(index int) (ref *TagInputSearch) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputSearch) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputSearch) RemoveZIndex() (ref *TagInputSearch) {
