// browser/html/typeTagSvgMask.go
//
...
func (e *TagSvgMask) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgMask) CreateElement() (ref *TagSvgMask) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "mask")
...
func (e *TagSvgMask) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgMask) Tabindex(value interface{}) (ref *TagSvgMask) {
...
func (e *TagSvgMask) Cursor(value interface{}) (ref *TagSvgMask) {
...
//	    mais informações.
func (e *TagSvgMask) Direction(value interface{}) (ref *TagSvgMask) {
...
func (e *TagSvgMask) DominantBaseline(value interface{}) (ref *TagSvgMask) {
...
func (e *TagSvgMask) FillRule(value interface{}) (ref *TagSvgMask) {
...
func (e *TagSvgMask) FontStyle(value interface{}) (ref *TagSvgMask) {
...
func (e *TagSvgMask) GetXY() (x, y int) {
	x = e.x
	y = e.y
	return
}
...
func (e *TagSvgMask) GetTop() (top float64) {
...
func (e *TagSvgMask) GetRight() (right float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgMask) GetBottom() (bottom float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgMask) GetLeft() (left float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgMask) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgMask) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgMask) ListenerRemove(event string) (ref *TagSvgMask) {
