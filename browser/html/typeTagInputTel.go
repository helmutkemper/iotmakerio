// browser/html/typeTagInputTel.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputTel) GetId() (id string) {
	return e.id
}
...
func (e *TagInputTel) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputTel) GetRight() (right int) {
...
func (e *TagInputTel) GetBottom() (bottom int) {
...
func (e *TagInputTel) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputTel) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputTel) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputTel) UpdateBoundingClientRect() (ref *TagInputTel) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputTel) SetDeltaX(delta int) (ref *TagInputTel) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputTel) SetDeltaY(delta int) (ref *TagInputTel) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputTel) Get() (el js.Value) {
...
func (e *TagInputTel) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputTel) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputTel) ListenerRemove(event string) (ref *TagInputTel) {
...
func (e *TagInputTel) SetAttribute(key string, value any) (ref *TagInputTel) {
...
func (e *TagInputTel) GetAttribute(key string) (value string) {
...
func (e *TagInputTel) RemoveAttribute(key string) (value string) {
...
func (e *TagInputTel) SetZIndex(index int) (ref *TagInputTel) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputTel) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputTel) RemoveZIndex() (ref *TagInputTel) {
