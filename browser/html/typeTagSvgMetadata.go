// browser/html/typeTagSvgMetadata.go
//
...
func (e *TagSvgMetadata) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgMetadata) CreateElement() (ref *TagSvgMetadata) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "metadata")
...
func (e *TagSvgMetadata) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgMetadata) Tabindex(value interface{}) (ref *TagSvgMetadata) {
...
func (e *TagSvgMetadata) Reference(reference **TagSvgMetadata) (ref *TagSvgMetadata) {
	*reference = e
	return e
}
