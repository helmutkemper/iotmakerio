// browser/html/typeTagInputColor.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputColor) GetId() (id string) {
	return e.id
}
...
func (e *TagInputColor) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputColor) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputColor) ListenerRemove(event string) (ref *TagInputColor) {
...
func (e *TagInputColor) SetAttribute(key string, value any) (ref *TagInputColor) {
...
func (e *TagInputColor) GetAttribute(key string) (value string) {
...
func (e *TagInputColor) RemoveAttribute(key string) (value string) {
...
func (e *TagInputColor) Remove(elements ...Compatible) (ref *TagInputColor) {
...
func (e *TagInputColor) SetZIndex(index int) (ref *TagInputColor) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputColor) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputColor) RemoveZIndex() (ref *TagInputColor) {
