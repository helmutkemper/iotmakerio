// browser/html/typeTagInputSubmit.go
//
...
func (e *TagInputSubmit) Reference(reference **TagInputSubmit) (ref *TagInputSubmit) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputSubmit) GetId() (id string) {
	return e.id
}
...
func (e *TagInputSubmit) ItemProp(itemprop string) (ref *TagInputSubmit) {
...
func (e *TagInputSubmit) Part(part ...string) (ref *TagInputSubmit) {
...
func (e *TagInputSubmit) Nonce(nonce string) (ref *TagInputSubmit) {
...
func (e *TagInputSubmit) Append(append interface{}) (ref *TagInputSubmit) {
	switch append.(type) {
	case *TagInputSubmit:
		e.selfElement.Call("appendChild", append.(*TagInputSubmit).selfElement)
	case js.Value:
...
func (e *TagInputSubmit) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputSubmit) GetRight() (right int) {
...
func (e *TagInputSubmit) GetBottom() (bottom int) {
...
func (e *TagInputSubmit) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputSubmit) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputSubmit) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputSubmit) UpdateBoundingClientRect() (ref *TagInputSubmit) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputSubmit) SetDeltaX(delta int) (ref *TagInputSubmit) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputSubmit) SetDeltaY(delta int) (ref *TagInputSubmit) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputSubmit) Get() (el js.Value) {
...
func (e *TagInputSubmit) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputSubmit) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputSubmit) ListenerRemove(event string) (ref *TagInputSubmit) {
...
func (e *TagInputSubmit) SetAttribute(key string, value any) (ref *TagInputSubmit) {
...
func (e *TagInputSubmit) GetAttribute(key string) (value string) {
...
func (e *TagInputSubmit) RemoveAttribute(key string) (value string) {
...
func (e *TagInputSubmit) Remove(elements ...Compatible) (ref *TagInputSubmit) {
...
func (e *TagInputSubmit) SetZIndex(index int) (ref *TagInputSubmit) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputSubmit) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputSubmit) RemoveZIndex() (ref *TagInputSubmit) {
