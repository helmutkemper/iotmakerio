// browser/html/typeTagInputMonth.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputMonth) GetId() (id string) {
	return e.id
}
...
func (e *TagInputMonth) Max(max any) (ref *TagInputMonth) {
...
func (e *TagInputMonth) Min(min any) (ref *TagInputMonth) {
...
//	    :invalid pseudoclass.
func (e *TagInputMonth) Step(step any) (ref *TagInputMonth) {
...
func (e *TagInputMonth) Value(value any) (ref *TagInputMonth) {
...
func (e *TagInputMonth) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputMonth) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputMonth) ListenerRemove(event string) (ref *TagInputMonth) {
...
func (e *TagInputMonth) SetAttribute(key string, value any) (ref *TagInputMonth) {
...
func (e *TagInputMonth) GetAttribute(key string) (value string) {
...
func (e *TagInputMonth) RemoveAttribute(key string) (value string) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputMonth) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputMonth) RemoveZIndex() (ref *TagInputMonth) {
