// browser/html/typeTagInputImage.go
//
...
func (e *TagInputImage) Reference(reference **TagInputImage) (ref *TagInputImage) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputImage) GetId() (id string) {
	return e.id
}
...
func (e *TagInputImage) ItemProp(itemprop string) (ref *TagInputImage) {
...
func (e *TagInputImage) Part(part ...string) (ref *TagInputImage) {
...
func (e *TagInputImage) Nonce(nonce string) (ref *TagInputImage) {
...
func (e *TagInputImage) Append(append interface{}) (ref *TagInputImage) {
	switch append.(type) {
	case *TagInputImage:
		e.selfElement.Call("appendChild", append.(*TagInputImage).selfElement)
	case js.Value:
...
func (e *TagInputImage) GetTop() (top int) {
	return e.x - e.deltaMovieX
}
...
func (e *TagInputImage) GetRight() (right int) {
...
func (e *TagInputImage) GetBottom() (bottom int) {
...
func (e *TagInputImage) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagInputImage) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagInputImage) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputImage) UpdateBoundingClientRect() (ref *TagInputImage) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagInputImage) SetDeltaX(delta int) (ref *TagInputImage) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagInputImage) SetDeltaY(delta int) (ref *TagInputImage) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagInputImage) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputImage) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputImage) ListenerRemove(event string) (ref *TagInputImage) {
...
func (e *TagInputImage) SetAttribute(key string, value any) (ref *TagInputImage) {
...
func (e *TagInputImage) GetAttribute(key string) (value string) {
...
func (e *TagInputImage) RemoveAttribute(key string) (value string) {
...
func (e *TagInputImage) Remove(elements ...Compatible) (ref *TagInputImage) {
...
func (e *TagInputImage) SetZIndex(index int) (ref *TagInputImage) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputImage) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputImage) RemoveZIndex() (ref *TagInputImage) {
