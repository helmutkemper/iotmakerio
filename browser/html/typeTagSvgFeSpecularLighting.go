// browser/html/typeTagSvgFeSpecularLighting.go
//
...
func (e *TagSvgFeSpecularLighting) Init() (ref *TagSvgFeSpecularLighting) {
	e.CreateElement()
...
func (e *TagSvgFeSpecularLighting) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeSpecularLighting) CreateElement() (ref *TagSvgFeSpecularLighting) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feSpecularLighting")
...
func (e *TagSvgFeSpecularLighting) Id(id string) (ref *TagSvgFeSpecularLighting) {
	e.id = id
...
func (e *TagSvgFeSpecularLighting) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeSpecularLighting) Tabindex(value interface{}) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) Cursor(value interface{}) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) FillRule(value interface{}) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) FontStyle(value interface{}) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) Class(class string) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) Text(value string) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) Html(value string) (ref *TagSvgFeSpecularLighting) {
...
func (e *TagSvgFeSpecularLighting) Reference(reference **TagSvgFeSpecularLighting) (ref *TagSvgFeSpecularLighting) {
	*reference = e
	return e
}
...
func (e *TagSvgFeSpecularLighting) Remove(elements ...Compatible) (ref *TagSvgFeSpecularLighting) {
	for _, element := range elements {
