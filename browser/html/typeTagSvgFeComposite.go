// browser/html/typeTagSvgFeComposite.go
//
...
func (e *TagSvgFeComposite) CreateElement() (ref *TagSvgFeComposite) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feComposite")
...
func (e *TagSvgFeComposite) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgFeComposite) Tabindex(value interface{}) (ref *TagSvgFeComposite) {
...
func (e *TagSvgFeComposite) Cursor(value interface{}) (ref *TagSvgFeComposite) {
...
//	    mais informações.
func (e *TagSvgFeComposite) Direction(value interface{}) (ref *TagSvgFeComposite) {
...
func (e *TagSvgFeComposite) FillRule(value interface{}) (ref *TagSvgFeComposite) {
...
func (e *TagSvgFeComposite) FontStyle(value interface{}) (ref *TagSvgFeComposite) {
...
func (e *TagSvgFeComposite) Reference(reference **TagSvgFeComposite) (ref *TagSvgFeComposite) {
	*reference = e
	return e
}
...
func (e *TagSvgFeComposite) Remove(elements ...Compatible) (ref *TagSvgFeComposite) {
	for _, element := range elements {
