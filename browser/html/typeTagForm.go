...
func (e *TagForm) Reference(reference **TagForm) (ref *TagForm) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagForm) GetId() (id string) {
	return e.id
}
...
func (e *TagForm) ItemProp(itemprop string) (ref *TagForm) {
...
func (e *TagForm) Part(part ...string) (ref *TagForm) {
...
func (e *TagForm) Nonce(nonce string) (ref *TagForm) {
...
func (e *TagForm) Append(append interface{}) (ref *TagForm) {
	switch append.(type) {
	case *TagForm:
		e.selfElement.Call("appendChild", append.(*TagForm).selfElement)
	case js.Value:
...
func (e *TagForm) Method(method FormMethod) (ref *TagForm) {
	e.selfElement.Set("method", method.String())
	return e
}
...
func (e *TagForm) GetRight() (right int) {
...
func (e *TagForm) GetBottom() (bottom int) {
...
func (e *TagForm) GetLeft() (left int) {
	return e.y - e.deltaMovieY
}
...
func (e *TagForm) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagForm) UpdateBoundingClientRect() (ref *TagForm) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagForm) SetDeltaX(delta int) (ref *TagForm) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagForm) SetDeltaY(delta int) (ref *TagForm) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagForm) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagForm) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagForm) ListenerRemove(event string) (ref *TagForm) {
...
func (e *TagForm) SetAttribute(key string, value any) (ref *TagForm) {
...
func (e *TagForm) GetAttribute(key string) (value string) {
...
func (e *TagForm) RemoveAttribute(key string) (value string) {
...
func (e *TagForm) Remove(elements ...Compatible) (ref *TagForm) {
...
func (e *TagForm) SetZIndex(index int) (ref *TagForm) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagForm) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagForm) RemoveZIndex() (ref *TagForm) {
