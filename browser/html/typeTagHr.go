...
import (
	...
	"github.com/helmutkemper/iotmakerio/browser/css"
	"github.com/helmutkemper/iotmakerio/browser/event/mouse"
	"github.com/helmutkemper/iotmakerio/interfaces"
	"github.com/helmutkemper/iotmakerio/platform/algorithm"
)
...
func (e *TagHr) Reference(reference **TagHr) (ref *TagHr) {
	*reference = e
	return e
}
...
func (e *TagHr) AccessKey(key string) (ref *TagHr) {
...
func (e *TagHr) Autofocus(autofocus bool) (ref *TagHr) {
...
func (e *TagHr) Class(class ...string) (ref *TagHr) {
...
//	   seu pai.
func (e *TagHr) ContentEditable(editable bool) (ref *TagHr) {
...
//	    usuário.
func (e *TagHr) Data(data map[string]string) (ref *TagHr) {
	for k, v := range data {
...
//	        KDirAuto ]
func (e *TagHr) Dir(dir Dir) (ref *TagHr) {
...
//	    https://www.w3schools.com/html/html5_draganddrop.asp
func (e *TagHr) Draggable(draggable Draggable) (ref *TagHr) {
...
func (e *TagHr) EnterKeyHint(enterKeyHint EnterKeyHint) (ref *TagHr) {
...
func (e *TagHr) Id(id string) (ref *TagHr) {
	e.id = id
...
func (e *TagHr) InputMode(inputMode InputMode) (ref *TagHr) {
...
func (e *TagHr) Is(is string) (ref *TagHr) {
...
func (e *TagHr) ItemId(id string) (ref *TagHr) {
...
func (e *TagHr) ItemProp(itemprop string) (ref *TagHr) {
...
func (e *TagHr) ItemRef(itemref string) (ref *TagHr) {
...
func (e *TagHr) ItemType(itemType string) (ref *TagHr) {
...
func (e *TagHr) Lang(language Language) (ref *TagHr) {
...
func (e *TagHr) Part(part ...string) (ref *TagHr) {
...
func (e *TagHr) Nonce(nonce string) (ref *TagHr) {
...
//	desse atributo slot.
func (e *TagHr) Slot(slot string) (ref *TagHr) {
...
func (e *TagHr) Spellcheck(spell bool) (ref *TagHr) {
...
func (e *TagHr) Style(style string) (ref *TagHr) {
...
func (e *TagHr) TabIndex(index int) (ref *TagHr) {
...
// No entanto, não é necessariamente útil).
func (e *TagHr) Title(title string) (ref *TagHr) {
...
func (e *TagHr) Translate(translate Translate) (ref *TagHr) {
...
func (e *TagHr) CreateElement() (ref *TagHr) {
	e.selfElement = js.Global().Get("document").Call("createElement", "hr")
...
//	       var p = document.createElement("p");
//	       document.body.appendChild(p);
func (e *TagHr) AppendById(appendId string) (ref *TagHr) {
...
func (e *TagHr) Append(elements ...Compatible) (ref *TagHr) {
...
// todo: appendMany()
func (e *TagHr) AppendToStage() (ref *TagHr) {
	e.stage.Call("appendChild", e.selfElement)
	return e
}

func (e *TagHr) Get() (el js.Value) {
...
func (e *TagHr) Rotate(angle float64) (ref *TagHr) {
...
func (e *TagHr) RotateDelta(delta float64) (ref *TagHr) {
	e.rotateDelta = delta
	return e
}
...
//	 Saída:
//	   angle: delta, ângulo de ajuste da rotação do objeto.
func (e *TagHr) GetRotateDelta() (delta float64) {
...
//       log.Print(event.GetScreenY())
//     }
//func (e *TagHr) AddListener(eventType interface{}, manager mouse.SimpleManager) (ref *TagHr) {
//
...
//       log.Print(event.GetScreenY())
//     }
//func (e *TagHr) RemoveListener(eventType interface{}) (ref *TagHr) {
//	switch converted := eventType.(type) {
//	case event.Event:
...
//	              o resto
func (e *TagHr) Mouse(value mouse.CursorType) (ref *TagHr) {
...
func (e *TagHr) prepareStageReference() {
...
//       DragStart().
//       AppendById("stage")
//func (e *TagHr) DragStart() (ref *TagHr) {
//	e.dragNormalStart()
//	return e
//}
...
//       div.DragStop()
//     }()
//func (e *TagHr) DragStop() (ref *TagHr) {
//	e.dragNormalStop()
//	return e
//}

//func (e *TagHr) dragNormalStart() {
...
func (e *TagHr) onStopDragNormal(_ js.Value, _ []js.Value) interface{} {
	e.isDragging = false
	return nil
}

func (e *TagHr) onStartDragNormal(event mouse.Event) {
...
func (e *TagHr) onMouseDraggingNormal(_ js.Value, args []js.Value) interface{} {
...
//	     Exemplo:
//	       factoryEasingTween.NewLinear(5*time.Second, 0, 10000, div.EasingTweenWalkingAndRotateIntoPoints(), 0)
func (e *TagHr) AddPointsToEasingTween(algorithmRef algorithm.CurveInterface) (ref *TagHr) {
	if algorithmRef == nil {
		return e
	}
...
//	    Exemplo:
//	      factoryEasingTween.NewLinear(5*time.Second, 0, 10000, div.EasingTweenWalkingAndRotateIntoPoints(), 0)
func (e *TagHr) EasingTweenWalkingIntoPoints() (function func(percent, p float64, args interface{})) {
...
//	    Exemplo:
//	      factoryEasingTween.NewLinear(5*time.Second, 0, 10000, div.EasingTweenWalkingAndRotateIntoPoints(), 0)
func (e *TagHr) EasingTweenWalkingAndRotateIntoPoints() (function func(forTenThousand, percent float64, args interface{})) {
...
func (e *TagHr) Text(value string) (ref *TagHr) {
...
func (e *TagHr) Html(value string) (ref *TagHr) {
...
func (e *TagHr) GetRight() (right int) {
...
func (e *TagHr) GetBottom() (bottom int) {
...
func (e *TagHr) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagHr) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagHr) UpdateBoundingClientRect() (ref *TagHr) {
...
func (e *TagHr) SetXY(x, y int) (ref *TagHr) {
...
//	Valor adicional adicionado na função SetX(): (x = x + deltaMovieX)  e subtraído na função
//	GetX(): (x = x - deltaMovieX).
func (e *TagHr) SetDeltaX(delta int) (ref *TagHr) {
	e.deltaMovieX = delta
	return e
}
...
func (e *TagHr) SetDeltaY(delta int) (ref *TagHr) {
	e.deltaMovieY = delta
	return e
}
...
func (e *TagHr) SetX(x int) (ref *TagHr) {
...
func (e *TagHr) SetY(y int) (ref *TagHr) {
...
func (e *TagHr) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagHr) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagHr) ListenerRemove(event string) (ref *TagHr) {
	e.commonEvents.ListenerRemove(event)
	return e
}

func (e *TagHr) AddStyle(key string, value any) (ref *TagHr) {
	e.selfElement.Get("style").Set(key, value)
	return e
}

func (e *TagHr) GetStyleInt(key string) (value int) {
