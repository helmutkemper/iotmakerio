// browser/html/typeTagSvgTitle.go
//
...
func (e *TagSvgTitle) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgTitle) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgTitle) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgTitle) ListenerRemove(event string) (ref *TagSvgTitle) {
...
func (e *TagSvgTitle) SetAttribute(key string, value any) (ref *TagSvgTitle) {
...
func (e *TagSvgTitle) GetAttribute(key string) (value string) {
...
func (e *TagSvgTitle) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgTitle) Remove(elements ...Compatible) (ref *TagSvgTitle) {
	for _, element := range elements {
...
func (e *TagSvgTitle) SetZIndex(index int) (ref *TagSvgTitle) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgTitle) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgTitle) RemoveZIndex() (ref *TagSvgTitle) {
