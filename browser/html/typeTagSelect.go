...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagSelect) GetId() (id string) {
	return e.id
}
...
func (e *TagSelect) SetAttribute(key string, value any) (ref *TagSelect) {
...
func (e *TagSelect) GetAttribute(key string) (value string) {
...
func (e *TagSelect) RemoveAttribute(key string) (value string) {
...
func (e *TagSelect) Remove(elements ...Compatible) (ref *TagSelect) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSelect) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSelect) RemoveZIndex() (ref *TagSelect) {
