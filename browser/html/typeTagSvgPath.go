// browser/html/typeTagSvgPath.go
//
...
//	    usuário.
func (e *TagSvgPath) Data(data map[string]string) (ref *TagSvgPath) {
	for k, v := range data {
...
//	  * Atributos personalizados prefixados com "data-" serão completamente ignorados pelo agente do
//	    usuário.
func (e *TagSvgPath) DataKey(key, value string) (ref *TagSvgPath) {
...
//	  * Atributos personalizados prefixados com "data-" serão completamente ignorados pelo agente do
//	    usuário.
func (e *TagSvgPath) GetData(key string) (value string) {
...
func (e *TagSvgPath) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgPath) Tabindex(value interface{}) (ref *TagSvgPath) {
...
func (e *TagSvgPath) Cursor(value interface{}) (ref *TagSvgPath) {
...
//	    mais informações.
func (e *TagSvgPath) Direction(value interface{}) (ref *TagSvgPath) {
...
func (e *TagSvgPath) DominantBaseline(value interface{}) (ref *TagSvgPath) {
...
func (e *TagSvgPath) GetXY() (x, y int) {
	x = e.x
	y = e.y
	return
}
...
func (e *TagSvgPath) GetTop() (top float64) {
...
func (e *TagSvgPath) GetRight() (right float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgPath) GetBottom() (bottom float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgPath) GetLeft() (left float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgPath) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgPath) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgPath) ListenerRemove(event string) (ref *TagSvgPath) {
...
func (e *TagSvgPath) GetOffsetWidth() (width int) {
	return e.selfElement.Get("offsetWidth").Int()
}

func (e *TagSvgPath) GetClientWidth() (width int) {
	return e.selfElement.Get("clientWidth").Int()
}

func (e *TagSvgPath) GetClientHeight() (height int) {
...
//	Se o elemento estiver oculto (por exemplo, definindo o style.display no elemento ou um de seus antecessores para
//	"none"), então 0 será retornado.
func (e *TagSvgPath) GetOffsetHeight() (height int) {
...
func (e *TagSvgPath) GetOffsetLeft() (left int) {
...
//	mais próximo.
func (e *TagSvgPath) GetOffsetTop() (top int) {
...
func (e *TagSvgPath) SetAttribute(key string, value any) (ref *TagSvgPath) {
...
func (e *TagSvgPath) GetAttribute(key string) (value string) {
...
func (e *TagSvgPath) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgPath) Remove(elements ...Compatible) (ref *TagSvgPath) {
	for _, element := range elements {
...
func (e *TagSvgPath) SetZIndex(index int) (ref *TagSvgPath) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgPath) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgPath) RemoveZIndex() (ref *TagSvgPath) {
