// browser/html/typeTagSvgMarker.go
//
...
func (e *TagSvgMarker) prepareStageReference() {
...
func (e *TagSvgMarker) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgMarker) Tabindex(value interface{}) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) Cursor(value interface{}) (ref *TagSvgMarker) {
...
//	    mais informações.
func (e *TagSvgMarker) Direction(value interface{}) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) DominantBaseline(value interface{}) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) FillRule(value interface{}) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) FontStyle(value interface{}) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) GetXY() (x, y int) {
	x = e.x
	y = e.y
	return
}
...
func (e *TagSvgMarker) GetX() (x int) {
	return e.x
}
...
func (e *TagSvgMarker) GetY() (y int) {
	return e.y
}
...
func (e *TagSvgMarker) GetTop() (top float64) {
...
func (e *TagSvgMarker) GetRight() (right float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgMarker) GetBottom() (bottom float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgMarker) GetLeft() (left float64) {
	var coordinate = e.selfElement.Call("getBoundingClientRect")
...
func (e *TagSvgMarker) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgMarker) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgMarker) ListenerRemove(event string) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) SetAttribute(key string, value any) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) GetAttribute(key string) (value string) {
...
func (e *TagSvgMarker) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgMarker) Remove(elements ...Compatible) (ref *TagSvgMarker) {
	for _, element := range elements {
...
func (e *TagSvgMarker) SetZIndex(index int) (ref *TagSvgMarker) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgMarker) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgMarker) RemoveZIndex() (ref *TagSvgMarker) {
