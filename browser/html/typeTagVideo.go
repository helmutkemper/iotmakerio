...
import (
	...
	"github.com/helmutkemper/iotmakerio/browser/event"
	"github.com/helmutkemper/iotmakerio/browser/event/mouse"
	"github.com/helmutkemper/iotmakerio/browser/media"
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagVideo) GetId() (id string) {
	return e.id
}
...
func (e *TagVideo) SetAttribute(key string, value any) (ref *TagVideo) {
...
func (e *TagVideo) GetAttribute(key string) (value string) {
...
func (e *TagVideo) RemoveAttribute(key string) (value string) {
...
func (e *TagVideo) Remove(elements ...Compatible) (ref *TagVideo) {
	for _, element := range elements {
...
func (e *TagVideo) SetZIndex(index int) (ref *TagVideo) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagVideo) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagVideo) RemoveZIndex() (ref *TagVideo) {
