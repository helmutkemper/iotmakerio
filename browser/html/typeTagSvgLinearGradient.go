// browser/html/typeTagSvgLinearGradient.go
//
...
func (e *TagSvgLinearGradient) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgLinearGradient) CreateElement() (ref *TagSvgLinearGradient) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "linearGradient")
...
func (e *TagSvgLinearGradient) Id(id string) (ref *TagSvgLinearGradient) {
	e.id = id
...
func (e *TagSvgLinearGradient) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgLinearGradient) Tabindex(value interface{}) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) Cursor(value interface{}) (ref *TagSvgLinearGradient) {
...
//	    mais informações.
func (e *TagSvgLinearGradient) Direction(value interface{}) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) DominantBaseline(value interface{}) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) FillRule(value interface{}) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) FontStyle(value interface{}) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) HRef(href interface{}) (ref *TagSvgLinearGradient) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgLinearGradient) ListenerRemove(event string) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) SetAttribute(key string, value any) (ref *TagSvgLinearGradient) {
...
func (e *TagSvgLinearGradient) GetAttribute(key string) (value string) {
...
func (e *TagSvgLinearGradient) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgLinearGradient) SetZIndex(index int) (ref *TagSvgLinearGradient) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgLinearGradient) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgLinearGradient) RemoveZIndex() (ref *TagSvgLinearGradient) {
