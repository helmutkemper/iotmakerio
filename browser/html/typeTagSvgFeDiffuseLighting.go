// browser/html/typeTagSvgFeDiffuseLighting.go
//
...
// Português:
//
// A primitiva de filtro SVG <feDiffuseLighting> ilumina uma imagem usando o canal alfa como um mapa de relevo.
// A imagem resultante, que é uma imagem opaca RGBA, depende da cor da luz, posição da luz e geometria da superfície do
// mapa de relevo de entrada.
//
...
func (e *TagSvgFeDiffuseLighting) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgFeDiffuseLighting) CreateElement() (ref *TagSvgFeDiffuseLighting) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "feDiffuseLighting")
...
func (e *TagSvgFeDiffuseLighting) Id(id string) (ref *TagSvgFeDiffuseLighting) {
	e.id = id
...
func (e *TagSvgFeDiffuseLighting) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgFeDiffuseLighting) Cursor(value interface{}) (ref *TagSvgFeDiffuseLighting) {
...
//	    mais informações.
func (e *TagSvgFeDiffuseLighting) Direction(value interface{}) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) DominantBaseline(value interface{}) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) FillRule(value interface{}) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) FontStyle(value interface{}) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) Class(class string) (ref *TagSvgFeDiffuseLighting) {
