// browser/html/typeTagFigCaption.go
//
...
func (e *TagFigCaption) Reference(reference **TagFigCaption) (ref *TagFigCaption) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagFigCaption) GetId() (id string) {
	return e.id
}
...
func (e *TagFigCaption) ItemProp(itemprop string) (ref *TagFigCaption) {
...
func (e *TagFigCaption) Part(part ...string) (ref *TagFigCaption) {
...
func (e *TagFigCaption) Nonce(nonce string) (ref *TagFigCaption) {
...
func (e *TagFigCaption) CreateElement() (ref *TagFigCaption) {
	e.selfElement = js.Global().Get("document").Call("createElement", "figcaption")
...
func (e *TagFigCaption) prepareStageReference() {
...
func (e *TagFigCaption) onMouseDraggingNormal(_ js.Value, args []js.Value) interface{} {
...
func (e *TagFigCaption) GetBoundingBox() (x, y, width, height int) {
...
func (e *TagFigCaption) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagFigCaption) UpdateBoundingClientRect() (ref *TagFigCaption) {
...
func (e *TagFigCaption) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagFigCaption) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagFigCaption) ListenerRemove(event string) (ref *TagFigCaption) {
...
func (e *TagFigCaption) SetAttribute(key string, value any) (ref *TagFigCaption) {
...
func (e *TagFigCaption) GetAttribute(key string) (value string) {
...
func (e *TagFigCaption) RemoveAttribute(key string) (value string) {
...
func (e *TagFigCaption) SetZIndex(index int) (ref *TagFigCaption) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagFigCaption) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagFigCaption) RemoveZIndex() (ref *TagFigCaption) {
