// browser/html/typeTagInputButton.go
//
...
func (e *TagInputButton) Reference(reference **TagInputButton) (ref *TagInputButton) {
	*reference = e
	return e
}
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputButton) GetId() (id string) {
	return e.id
}
...
func (e *TagInputButton) ItemProp(itemprop string) (ref *TagInputButton) {
...
func (e *TagInputButton) Part(part ...string) (ref *TagInputButton) {
...
func (e *TagInputButton) Nonce(nonce string) (ref *TagInputButton) {
...
func (e *TagInputButton) CollisionBoundingBox(elemnt CollisionBoundingBox) (collision bool) {
...
func (e *TagInputButton) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagInputButton) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputButton) ListenerRemove(event string) (ref *TagInputButton) {
...
func (e *TagInputButton) SetAttribute(key string, value any) (ref *TagInputButton) {
...
func (e *TagInputButton) GetAttribute(key string) (value string) {
...
func (e *TagInputButton) RemoveAttribute(key string) (value string) {
...
func (e *TagInputButton) Remove(elements ...Compatible) (ref *TagInputButton) {
...
func (e *TagInputButton) SetZIndex(index int) (ref *TagInputButton) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputButton) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputButton) RemoveZIndex() (ref *TagInputButton) {
