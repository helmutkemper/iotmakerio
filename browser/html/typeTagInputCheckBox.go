// browser/html/typeTagInputCheckBox.go
//
...
// O atributo id é mais usado para apontar para um estilo em uma folha de estilo, e por JavaScript
// (através do HTML DOM) para manipular o elemento com o id específico.
func (e *TagInputCheckBox) GetId() (id string) {
	return e.id
}
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagInputCheckBox) ListenerRemove(event string) (ref *TagInputCheckBox) {
...
func (e *TagInputCheckBox) SetAttribute(key string, value any) (ref *TagInputCheckBox) {
...
func (e *TagInputCheckBox) GetAttribute(key string) (value string) {
...
func (e *TagInputCheckBox) RemoveAttribute(key string) (value string) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputCheckBox) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagInputCheckBox) RemoveZIndex() (ref *TagInputCheckBox) {
