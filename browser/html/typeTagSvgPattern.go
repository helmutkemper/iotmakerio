// browser/html/typeTagSvgPattern.go
//
...
func (e *TagSvgPattern) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgPattern) CreateElement() (ref *TagSvgPattern) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "pattern")
...
func (e *TagSvgPattern) GetId() (id string) {
	return e.id
}
...
func (e *TagSvgPattern) Cursor(value interface{}) (ref *TagSvgPattern) {
...
func (e *TagSvgPattern) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgPattern) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgPattern) ListenerRemove(event string) (ref *TagSvgPattern) {
...
func (e *TagSvgPattern) SetAttribute(key string, value any) (ref *TagSvgPattern) {
...
func (e *TagSvgPattern) GetAttribute(key string) (value string) {
...
func (e *TagSvgPattern) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgPattern) SetZIndex(index int) (ref *TagSvgPattern) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgPattern) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgPattern) RemoveZIndex() (ref *TagSvgPattern) {
