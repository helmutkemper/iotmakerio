// browser/html/typeTagSvgDiscard.go
//
...
func (e *TagSvgDiscard) prepareStageReference() {
...
func (e *TagSvgDiscard) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgDiscard) Tabindex(value interface{}) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) Cursor(value interface{}) (ref *TagSvgDiscard) {
...
//	    mais informações.
func (e *TagSvgDiscard) Direction(value interface{}) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) DominantBaseline(value interface{}) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) FillRule(value interface{}) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) FontStyle(value interface{}) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgDiscard) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgDiscard) ListenerRemove(event string) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) SetAttribute(key string, value any) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) GetAttribute(key string) (value string) {
...
func (e *TagSvgDiscard) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgDiscard) SetZIndex(index int) (ref *TagSvgDiscard) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgDiscard) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgDiscard) RemoveZIndex() (ref *TagSvgDiscard) {
