// browser/html/typeTagSvgDefs.go
//
...
func (e *TagSvgDefs) prepareStageReference() {
	e.stage = js.Global().Get("document").Get("body")
}

func (e *TagSvgDefs) CreateElement() (ref *TagSvgDefs) {
	e.selfElement = js.Global().Get("document").Call("createElementNS", "http://www.w3.org/2000/svg", "defs")
...
func (e *TagSvgDefs) GetId() (id string) {
	return e.id
}
...
//	    qualquer outro tipo: interface{}
func (e *TagSvgDefs) Tabindex(value interface{}) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) Cursor(value interface{}) (ref *TagSvgDefs) {
...
//	    mais informações.
func (e *TagSvgDefs) Direction(value interface{}) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) DominantBaseline(value interface{}) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) FillRule(value interface{}) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) FontStyle(value interface{}) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) Reference(reference **TagSvgDefs) (ref *TagSvgDefs) {
	*reference = e
	return e
}
...
func (e *TagSvgDefs) ListenerAddReflect(event string, params []interface{}, functions []reflect.Value, reference any) (ref *TagSvgDefs) {
...
//	  beforetoggle: Fired when the element is a popover, before it is hidden or shown.
//	  toggle:       Fired when the element is a popover, just after it is hidden or shown.
func (e *TagSvgDefs) ListenerRemove(event string) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) SetAttribute(key string, value any) (ref *TagSvgDefs) {
...
func (e *TagSvgDefs) GetAttribute(key string) (value string) {
...
func (e *TagSvgDefs) RemoveAttribute(key string) (value string) {
...
func (e *TagSvgDefs) Remove(elements ...Compatible) (ref *TagSvgDefs) {
	for _, element := range elements {
...
func (e *TagSvgDefs) SetZIndex(index int) (ref *TagSvgDefs) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgDefs) GetZIndex() (index int) {
...
//
// Elementos sobrepostos com um z-index maior cobrem aqueles com um z-index menor.
func (e *TagSvgDefs) RemoveZIndex() (ref *TagSvgDefs) {
